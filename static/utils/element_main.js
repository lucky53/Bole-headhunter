(function() {
  var aa = '" style="background-image:url(', ba = '-disabled', da = '-document.getElementById(\'', ea = '/translate_a/t',
    fa = '/translate_suggestion?client=', ha = '</button></div></div></td></tr><tr id="',
    ...
    na = 'IFRAME', oa = 'INPUT', pa = 'INTERNAL_SERVER_ERROR', qa = 'OPTION', ra = 'Opera', sa = 'POST', ta = 'SCRIPT',
    ua = 'SPAN', va = 'TEXTAREA', wa = 'TITLE', xa = 'Unable to set parent component',
    ya = '[goog.net.IframeIo] Unable to send, already active.', za = 'about:invalid#zClosurez',
    Aa = 'about:invalid#zSoyz', Ba = 'absolute', Ca = 'action', Da = 'activedescendant', Ea = 'activity-form-container',
    Fa = 'alt-edited', Ga = 'array', Ha = 'auto', Ia = 'backgroundImage', Ja = 'backgroundPosition', Ka = 'blur',
    La = 'border-box', Ma = 'button', Na = 'cancelled', Oa = 'change',
    Pa = 'character', Qa = 'checked', Ra = 'chg_tgt_lang', Sa = 'click', Ta = 'clk_no_ap_site', Ua = 'complete',
    Va = 'container', Wa = 'contextmenu', Xa = 'dblclick', Ya = 'direction', Za = 'div', $a = 'finish',
    ...
    pb = 'goog-te-spinner-pos-show', qb = 'hidden', rb = 'hide', sb = 'horizontal', ub = 'https://translate.google.com',
    vb = 'https://www.google.com/images/cleardot.gif', wb = 'javascript:void(0)', xb = 'keydown', yb = 'keypress',
    zb = 'load', Ab = 'mousedown', Bb = 'mousemove', Cb = 'mouseout', Db = 'mouseover', Eb = 'move_offscreen',
    q = 'none', Fb = 'number', Gb = 'object', Hb = 'opacity 1s linear', Ib = 'paddingLeft', Jb = 'paddingRight',
    Kb = 'position', Lb = 'progressSection', Mb = 'promptSourceLang', Nb = 'promptTargetLang', Ob = 'ready',
    Pb = 'readystatechange', Qb = 'rtl',
    Rb = 'selected', Sb = 'skiptranslate', Tb = 'status-message', Ub = 'string', Vb = 'submitted',
    Wb = 'targetLanguage', Xb = 'textarea-placeholder-input', Yb = 'toggle_display', Zb = 'trans-target-empty',
    $b = 'trans-target-highlight', ac = 'transition', bc = 'translate', cc = 'vertical', dc = 'visible',
    ec = 'withCredentials';
  ...
  function A(a) {
    ...
    if (b == Gb) {
      if (a) {
        ...
        if ('[object Array]' == c || typeof a.length == Fb && 'undefined' != typeof a.splice && 'undefined' != typeof a.propertyIsEnumerable && !a.propertyIsEnumerable('splice')) return Ga;
  ...
  var Fc, Gc = { Tj: 1, Ij: 2, nk: 3, Lj: 4, Vj: 5, Uj: 6, fk: 7, Nj: 8, Oj: 9, Qj: 10, Pj: 11, ck: 12 };
  ...
  function fd(a, b) {
    for (var c, d, e = 1; e < arguments.length; e++) {
      d = arguments[e];
      for (c in d) a[c] = d[c];
      for (var f = 0; f < ed.length; f++) c = ed[f], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c]);
    }
  }

  function gd(a) {
    var b = arguments.length;
    if (1 == b && B(arguments[0])) return gd.apply(null, arguments[0]);
  ...
  function rd(a) {
    if (a instanceof od && a.constructor === od && a.f === qd) return a.b;
    A(a);
  ...
  function Id(a) {
    if (a instanceof Fd && a.constructor === Fd && a.c === Hd) return a.b;
    A(a);
  ...
  function Nd(a) {
    if (a instanceof Ld && a.constructor === Ld && a.b === Md) return a.a;
    A(a);
  ...
  function Qd(a) {
    if (a instanceof Fd) return 'url("' + Id(a).toString().replace(/</g, '%3c').replace(/[\\"]/g, '\\$&') + '")';
    if (a instanceof id) {
      a = ld(a);
    } else {
      a = String(a);
  ...
  function Zd(a) {
    if (a instanceof Xd && a.constructor === Xd && a.b === Yd) return a.a;
    A(a);
  ...
  function ke(a) {
    if (a instanceof ie && a.constructor === ie && a.f === je) return a.b;
    A(a);
  ...
  function le(a) {
    ...
    var b = typeof a == Gb, c = null;
    b && a.Qe && (c = a.a());
    return me(vd(b && a.gb ? a.La() : String(a)), c);
  }

  var ne = /^[a-zA-Z0-9-]+$/,
    oe = { action: !0, cite: !0, data: !0, formaction: !0, href: !0, manifest: !0, poster: !0, src: !0 }, pe = {
      APPLET: !0,
      BASE: !0,
      EMBED: !0,
      IFRAME: !0,
  ...
  function qe(a, b) {
    var c = String(a);
    if (!ne.test(c)) throw Error('');
    if (c.toUpperCase() in pe) throw Error('');
    a = String(a);
    c = null;
    var d = '<' + a, e = '';
    if (b) {
      for (n in b) {
        if (!ne.test(n)) throw Error('');
        var f = b[n];
        if (null != f) {
          var h = n;
          var k = f;
          if (k instanceof id) {
            ...
            if (h.toLowerCase() in oe) if (k instanceof od) k = rd(k).toString(); else if (k instanceof Fd) k = Id(k).toString(); else if (y(k)) k = Kd(k).La(); else throw Error('');
          }
          k.gb && (k = k.La());
          h = h + '="' + vd(String(k)) + '"';
          e += ' ' + h;
    ...
    d = void 0;
    null != d ? B(d) || (d = [d]) : d = [];
    !0 === hd[a.toLowerCase()] ? n += '>' : (c = re(d), n += '>' + ke(c).toString() + '</' + a + '>', c = c.a());
  ...
  function te(a) {
    function b(f) {
      B(f) ? Kc(f, b) : (f = le(f), e.push(ke(f).toString()), f = f.a(), 0 == d ? d = f : 0 != f && d != f && (d = null));
    }
  ...
  function ye(a, b) {
    b instanceof Fd || b instanceof Fd || (b = typeof b == Gb && b.gb ? b.La() : String(b), Jd.test(b) || (b = za), b = new Fd(Gd, b));
    a.action = Id(b);
  }
  ...
  function Je(a) {
    ...
    return a.replace(Le, function(d, e) {
      ...
      f || (f = se(d + ' ', null), xe(c, f), f = c.firstChild.nodeValue.slice(0, -1));
      return b[d] = f;
    });
  }
  ...
  };var Te = H(ra), I = ee(), Ue = H(la), Ve = Ue || I,
    J = H('Gecko') && !(-1 != ae.toLowerCase().indexOf('webkit') && !H(la)) && !(H('Trident') || H('MSIE')) && !H(la),
    K = -1 != ae.toLowerCase().indexOf('webkit') && !H(la), We = K && H('Mobile'), Xe = H('Macintosh'),
    Ye = H('Windows'), Ze = H('Android'), $e = Oe(), af = H('iPad'), bf = H('iPod'), cf = Pe();
  ...
  a:{
    var ff = '', gf = function() {
      ...
      if (Ue) return /Edge\/([\d\.]+)/.exec(a);
      if (I) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
      if (K) return /WebKit\/(\S+)/.exec(a);
      if (Te) return /(?:Version)[ \/]?(\S+)/.exec(a);
    }();
    gf && (ff = gf ? gf[1] : '');
    if (I) {
      var jf = df();
  ...
  var nf = of;
  var pf = fe(), qf = Oe() || H('iPod'), rf = H('iPad'), sf = H('Android') && !(ge() || fe() || H(ra) || H('Silk')),
    tf = ge(),
    uf = H('Safari') && !(ge() || H('Coast') || H(ra) || H(la) || H('Edg/') || H('OPR') || fe() || H('Silk') || H('Android')) && !Pe();
  var vf = null, wf = J || K && !uf || Te || !uf && !I && typeof x.atob == p;

  function xf(a) {
    if (wf) return x.atob(a);
    var b = '';
    yf(a, function(c) {
  ...
  function Cf(a, b, c) {
    ...
    a.h = {};
    if (c) for (b = 0; b < c.length; b++) d = c[b], d < a.g ? (d += a.f, a.b[d] = a.b[d] || Df) : (Ef(a), a.c[d] = a.c[d] || Df);
  }
  ...
  function Ff(a, b) {
    ...
    if (a.c) return c = a.c[b], c === Df ? a.c[b] = [] : c;
  }

  function Gf(a, b, c) {
    b < a.g ? a.b[b + a.f] = c : (Ef(a), a.c[b] = c);
    return a;
  }
  ...
  function If(a, b, c) {
    a.a || (a.a = {});
    if (!a.a[b]) {
      for (var d = Ff(a, b), e = [], f = 0; f < d.length; f++) e[f] = new c(d[f]);
      a.a[b] = e;
    }
    (d = a.a[b]) || (d = a.a[b] = []);
    c = new c;
  ...
  function Jf(a) {
    if (a.a) {
      for (var b in a.a) {
        var c = a.a[b];
        if (B(c)) for (var d = 0; d < c.length; d++) c[d] && c[d].Fb(); else c && c.Fb();
      }
    }
  }
  ...
  };var Pf = !I || mf(9), Qf = !J && !I || I && mf(9) || J && L('1.9.1'), Rf = I && !L('9'), Sf = I || Te || K,
    Tf = I && !mf(9);
  ...
  N.prototype.translate = function(a, b) {
    a instanceof N ? (this.x += a.x, this.y += a.y) : (this.x += Number(a), qc(b) && (this.y += b));
    return this;
  };
  ...
  function bg(a, b, c, d) {
    ...
    if (c) {
      d = {};
      for (f = e = 0; h = a[f]; f++) b = h.className, typeof b.split == p && Qc(b.split(/\s+/), c) && (d[e++] = h);
      d.length = e;
      return d;
    }
    return a;
  ...
  function og() {
    var a = qe('WBR'), b = document, c = b.createElement(g);
    I ? (a = re(ve, a), xe(c, a), c.removeChild(c.firstChild)) : xe(c, a);
  ...
  function Gg(a, b) {
    if ('textContent' in a) {
      ...
      rg(a), a.appendChild(O(a).createTextNode(String(b)));
    }
  }

  var Hg = { SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1 }, Ig = { IMG: ' ', BR: '\n' };
  ...
  function Kg(a) {
    return I && !L('9') ? (a = a.getAttributeNode('tabindex'), null != a && a.specified) : a.hasAttribute('tabindex');
  }
  ...
  function Ng(a, b, c) {
    if (!(a.nodeName in Hg)) if (3 == a.nodeType) c ? b.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, '')) : b.push(a.nodeValue); else if (a.nodeName in Ig) b.push(Ig[a.nodeName]); else for (a = a.firstChild; a;) Ng(a, b, c), a = a.nextSibling;
  }

  function ng(a) {
    if (a && typeof a.length == Fb) {
      if (wc(a)) return typeof a.item == p || typeof a.item == Ub;
  ...
  v.translate = function(a, b) {
    a instanceof N ? (this.left += a.x, this.right += a.x, this.top += a.y, this.bottom += a.y) : (this.left += a, this.right += a, qc(b) && (this.top += b, this.bottom += b));
    return this;
  };
  ...
  v.translate = function(a, b) {
    a instanceof N ? (this.left += a.x, this.top += a.y) : (this.left += a, qc(b) && (this.top += b));
    return this;
  };
  ...
  function ah(a) {
    if (I && !mf(8)) return a.offsetParent;
    var b = O(a), c = Wg(a, Kb), d = 'fixed' == c || c == Ba;
    for (a = a.parentNode; a && a != b; a = a.parentNode) if (11 == a.nodeType && a.host && (a = a.host), c = Wg(a, Kb), d = d && 'static' == c && a != b.documentElement && a != b.body, !d && (a.scrollWidth > a.clientWidth || a.scrollHeight > a.clientHeight || 'fixed' == c || c == Ba || 'relative' == c)) return a;
    return null;
  }
  ...
  function bh(a) {
    for (var b = new Rg(0, Infinity, Infinity, 0), c = Xf(a), d = c.a.body, e = c.a.documentElement, f = ig(c.a); a = ah(a);) {
      if (!(I && 0 == a.clientWidth || K && 0 == a.clientHeight && a == d) && a != d && a != e && Wg(a, 'overflow') != dc) {
        var h = ch(a), k = new N(a.clientLeft, a.clientTop);
        h.x += k.x;
        h.y += k.y;
  ...
  function dh(a, b) {
    var c = new N(0, 0), d = jg(O(a));
    if (!Re(d, 'parent')) return c;
    do {
      if (d == b) var e = ch(a); else e = $g(a), e = new N(e.left, e.top);
      c.x += e.x;
      c.y += e.y;
  ...
  function fh(a) {
    ...
    return pc(b) && !d || !a.getBoundingClientRect ? new Wf(b, c) : (a = $g(a), new Wf(a.right - a.left, a.bottom - a.top));
  }
  ...
  function kh(a, b, c) {
    ...
    if (jh) {
      if (b = b ? q : '', a.style && (a.style[jh] = b), c) {
        a = 0;
        for (var d; d = c[a]; a++) d.style && (d.style[jh] = b);
      }
    } else if (I || Te) if (b = b ? 'on' : '', a.setAttribute('unselectable', b), c) for (a = 0; d = c[a]; a++) d.setAttribute('unselectable', b);
  }
  ...
  function mh(a, b) {
    ...
    if (!I || L('10') || c && L('8')) {
      ...
      var d = a.style;
      c ? (d.pixelWidth = b.width, d.pixelHeight = b.height) : (c = oh(a), a = ph(a), d.pixelWidth = b.width + a.left + c.left + c.right + a.right, d.pixelHeight = b.height + a.top + c.top + c.bottom + a.bottom);
    }
  }
  ...
  function oh(a) {
    if (I) {
      var b = rh(a, Ib), c = rh(a, Jb), d = rh(a, 'paddingTop');
  ...
  function ph(a) {
    if (I && !mf(9)) {
      var b = th(a, 'borderLeft'), c = th(a, 'borderRight'), d = th(a, 'borderTop');
      a = th(a, 'borderBottom');
      return new Rg(d, c, a, b);
    }
  ...
  function wh(a, b, c) {
    ...
    '' === c || void 0 == c ? (uh || (uh = {
      ...
      hidden: !1,
      invalid: 'false',
    }), c = uh, b in c ? a.setAttribute(d, c[b]) : a.removeAttribute(d)) : a.setAttribute(d, c);
  };
  ...
  function xh(a, b) {
    a.ub ? pc(void 0) ? b.call(void 0) : b() : (a.wa || (a.wa = []), a.wa.push(pc(void 0) ? C(b, void 0) : b));
  }
  ...
  function yh(a) {
    a && typeof a.M == p && a.M();
  };var zh = !I || mf(9), Ah = !I || mf(9), Bh = I && !L('9'), Ch = function() {
    ...
    try {
      x.addEventListener('test', z, b), x.removeEventListener('test', z, b);
    } catch (c) {
    }
    return a;
  }();
  ...
  var Eh = { Wb: Ab, Xb: 'mouseup', qc: 'mousecancel', $j: Bb, bk: Db, ak: Cb, Yj: 'mouseenter', Zj: 'mouseleave' };
  ...
  function Fh(a, b) {
    ...
    if (a) {
      ...
      (b = a.relatedTarget) ? J && (Re(b, 'nodeName') || (b =
        null)) : c == Db ? b = a.fromElement : c == Cb && (b = a.toElement);
  ...
  G(Fh, Dh);
  var Hh = [1, 4, 2], Gh = { 2: 'touch', 3: 'pen', 4: 'mouse' };
  ...
  Oh.prototype.add = function(a, b, c, d, e) {
    ...
    a || (a = this.a[f] = [], this.b++);
    var h = Ph(a, b, d, e);
    -1 < h ? (b = a[h], c || (b.dd = !1)) : (b = new Mh(b, this.src, f, !!d, e), b.dd = c, a.push(b));
    return b;
  };
  ...
  function Qh(a, b) {
    ...
    var d = Rc(a.a[c], b);
    d && (Nh(b), 0 == a.a[c].length && (delete a.a[c], a.b--));
    return d;
  }
  ...
  function Rh(a, b) {
    ...
    for (d in a.a) {
      if (!b || d == b) {
        for (var e = a.a[d], f = 0; f < e.length; f++) ++c, Nh(e[f]);
        delete a.a[d];
        a.b--;
      }
    }
  ...
  Oh.prototype.hasListener = function(a, b) {
    var c = pc(a), d = c ? a.toString() : '', e = pc(b);
  ...
  function Ph(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e];
      if (!f.oc && f.listener == b && f.capture == !!c && f.Hd == d) return e;
    }
    return -1;
  };var Sh = 'closure_lm_' + (1E6 * Math.random() | 0), Th = {}, Uh = 0;
  ...
  function Xh(a, b, c, d, e, f) {
    ...
    d.src = a;
    d.listener = c;
    if (a.addEventListener) Ch || (e = h), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e); else if (a.attachEvent) a.attachEvent($h(b.toString()), d); else if (a.addListener && a.removeListener) a.addListener(d); else throw Error('addEventListener and attachEvent are unavailable.');
    Uh++;
    return c;
  }

  function Zh() {
    var a = ai, b = Ah ? function(c) {
  ...
  function bi(a, b, c, d, e) {
    if (B(b)) for (var f = 0; f < b.length; f++) bi(a, b[f], c, d, e); else d = wc(d) ? !!d.capture : !!d, c = Wh(c), Kh(a) ? a.ba(b, c, d, e) : a && (a = Yh(a)) && (b = a.Ec(b, c, d, e)) && ci(b);
  }

  function ci(a) {
    if (qc(a) || !a || a.oc) return !1;
    var b = a.src;
    if (Kh(b)) return Qh(b.Ka, a);
    var c = a.type, d = a.a;
    ...
    Uh--;
    (c = Yh(b)) ? (Qh(c, a), 0 == c.b && (c.src = null, b[Sh] = null)) : Nh(a);
    return !0;
  }

  function di(a, b) {
    if (!a) return 0;
    if (Kh(a)) return a.Ka ? Rh(a.Ka, b) : 0;
    a = Yh(a);
    if (!a) return 0;
    var c = 0;
    b = b && b.toString();
    for (var d in a.a) if (!b || d == b) for (var e = a.a[d].concat(), f = 0; f < e.length; ++f) ci(e[f]) && ++c;
    return c;
  }
    ...
    if (a = Yh(a)) {
      if (b = a.a[b.toString()]) {
        for (b = b.concat(), a = 0; a < b.length; a++) {
          var f = b[a];
          f && f.capture == c && !f.oc && (f = fi(f, d), e = e && !1 !== f);
        }
      }
    }
    return e;
  ...
  function li(a, b, c, d, e, f) {
    if (B(c)) {
      for (var h = 0; h < c.length; h++) li(a, b, c[h], d, e, f);
    } else {
  ...
  v.ba = function(a, b, c, d, e) {
    if (B(b)) for (var f = 0; f < b.length; f++) this.ba(a, b[f], c, d, e); else c = c || this.handleEvent, d = wc(d) ? !!d.capture : !!d, e = e || this.b || this, c = Wh(c), d = !!d, b = Kh(a) ? a.Ec(b, c, d, e) : a ? (a = Yh(a)) ? a.Ec(b, c, d, e) : null : null, b && (ci(b), delete this.a[b.key]);
    return this;
  };
  ...
  v.dispatchEvent = function(a) {
    ...
    a.c || (h = a.currentTarget = b, e = oi(h, d, !0, a) && e, a.c || (e = oi(h, d, !1, a) && e));
    if (c) for (f = 0; !a.c && f < c.length; f++) h = a.currentTarget = c[f], e = oi(h, d, !1, a) && e;
    return e;
  };
  v.F = function() {
    ni.m.F.call(this);
  ...
  function vi(a, b) {
    ...
    if (b && a.B && a.ia && wi(a.B, a.ia) && a.B != b) throw Error(xa);
    a.B = b;
    T.m.uf.call(a, b);
  }
  ...
  v.he = function(a, b, c) {
    ...
    vi(a, this);
    Uc(this.s, b, 0, a);
    a.U && this.U && a.wb() == this ? (c = this.td(), b = c.childNodes[b] || null, b != a.j() && c.insertBefore(a.j(), b)) : c ? (this.A || this.D(), b = Bi(this, b + 1), xi(a, this.td(), b ? b.A : null)) : this.U && !a.U && a.A && a.A.parentNode && 1 == a.A.parentNode.nodeType && a.O();
  };
  v.td = t('A');
  ...
  v.Qc = function(a) {
    for (var b = []; this.s && 0 != this.s.length;) b.push(this.removeChild(Bi(this, 0), a));
    return b;
  };
  ...
  v.Oa = function(a, b) {
    ...
    var d = 0, e = this.da(), f = this.da(), h = !1, k = !1, l = !1, m = Tc(Kf(b));
    Kc(m, function(r) {
      h || r != e ? k || r != f ? d |= this.od(r) : k = !0 : (h = !0, f == e && (k = !0));
  ...
  function Li(a, b, c) {
    if (a = c || a.$b()) c = b.getAttribute('role') || null, a != c && vh(b, a);
  }
  ...
  v.Wa = function(a, b, c) {
    Fi || (Fi = { 1: 'disabled', 8: Rb, 16: Qa, 64: 'expanded' });
    b = Fi[b];
    var d = a.getAttribute('role') || null;
    d && (d = Gi[d] || b, b = b == Qa || b == Rb ? d : b);
    b && wh(a, b, c);
  };
  v.Ic = function(a, b) {
    var c = this.zb(a);
    c && (rg(c), b && (y(b) ? Gg(c, b) : (a = function(d) {
      if (d) {
        var e = O(c);
  ...
  v.D = function(a) {
    var b = Pi.m.D.call(this, a), c = a.l;
  ...
  function Si(a, b, c, d, e, f) {
    ...
    if (!J) {
      ...
      if ((!c || Xe) && h || Xe && 16 == b && (d || f)) return !1;
    }
    if ((K || Ue) && d && c) {
      switch (a) {
        case 220:
  ...
  function Ri(a) {
    if (48 <= a && 57 >= a || 96 <= a && 106 >= a || 65 <= a && 90 >= a || (K || Ue) && 0 == a) return !0;
    switch (a) {
      case 32:
      case 43:
      case 63:
  ...
  v = Vi.prototype;
  v.ki = function(a) {
    if (K || Ue) if (17 == this.Fa && !a.ctrlKey || 18 == this.Fa && !a.altKey || Xe && 91 == this.Fa && !a.metaKey) this.hb = this.Fa = -1;
    -1 == this.Fa && (a.ctrlKey && 17 != a.keyCode ? this.Fa = 17 : a.altKey && 18 != a.keyCode ? this.Fa = 18 : a.metaKey && 91 != a.keyCode && (this.Fa = 91));
    Zi && !Si(a.keyCode, this.Fa, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey) ? this.handleEvent(a) : (this.hb = Ti(a.keyCode), $i && (this.ke = a.altKey));
  };
  v.li = function(a) {
    this.hb = this.Fa = -1;
    this.ke = a.altKey;
  ...
  v.handleEvent = function(a) {
    ...
    if (I && a.type == yb) {
      ...
      (K || Ue) && a.type == yb ? (d = this.hb, e = 0 <= b.charCode && 63232 > b.charCode && Ri(d) ? b.charCode : 0) : Te && !K ? (d = this.hb, e = Ri(d) ? b.keyCode : 0) : (a.type == yb ? ($i && (c = this.ke), b.keyCode == b.charCode ? 32 > b.keyCode ? (d = b.keyCode, e = 0) : (d = this.hb, e = b.charCode) : (d = b.keyCode || this.hb, e = b.charCode || 0)) : (d = b.keyCode || this.hb, e = b.charCode || 0), Xe && 63 == e && 224 == d && (d = 191));
    }
    var f = d = Ti(d);
    d ? 63232 <= d && d in Xi ? f = Xi[d] : 25 == d &&
      a.shiftKey && (f = 9) : b.keyIdentifier && b.keyIdentifier in Yi && (f = Yi[b.keyIdentifier]);
    J && Zi && a.type == yb && !Si(f, this.Fa, a.shiftKey, a.ctrlKey, c, a.metaKey) || (a = f == this.Fa, this.Fa = f, b = new aj(f, e, a, b), b.altKey = c, this.dispatchEvent(b));
  };
  v.j = t('A');
  ...
  function bj(a) {
    a.Md && (ci(a.Md), ci(a.Ve), ci(a.Nd), a.Md = null, a.Ve = null, a.Nd = null);
    a.A = null;
    a.Fa = -1;
    a.hb = -1;
  }
  ...
  v.O = function() {
    ...
    this.a.gg(this);
    if (this.aa & -2 && (this.Ne && gj(this, !0), this.aa & 32)) {
      var a = this.j();
      if (a) {
  ...
  function gj(a, b) {
    var c = U(a), d = a.j();
    b ? (c.w(d, Eh.Wb, a.Lc).w(d, [Eh.Xb, Eh.qc], a.dc).w(d, Db, a.He).w(d, Cb, a.Oe), a.Nc != z && c.w(d, Wa, a.Nc), I && (L(9) || c.w(d, Xa, a.lg), a.h || (a.h = new hj(a), xh(a, Cc(yh, a.h))))) : (c.ba(d, Eh.Wb, a.Lc).ba(d, [Eh.Xb, Eh.qc], a.dc).ba(d, Db, a.He).ba(d, Cb, a.Oe), a.Nc != z && c.ba(d, Wa, a.Nc), I && (L(9) || c.ba(d, Xa, a.lg), yh(a.h), a.h = null));
  }
  ...
  v.isVisible = t('ga');
  v.I = function(a, b) {
    return b || this.ga != a && this.dispatchEvent(a ? 'show' : rb) ? ((b = this.j()) && this.a.I(b, a), this.isEnabled() && this.a.ac(this, a), this.ga = a, !0) : !1;
  };
  ...
  v.ka = function(a) {
    var b = this.wb();
    b && typeof b.isEnabled == p && !b.isEnabled() || !ij(this, 1, !a) || (a || (jj(this, !1), kj(this, !1)), this.isVisible() && this.a.ac(this, a), lj(this, 1, !a, !0));
  };
  ...
  v.Oe = function(a) {
    a.relatedTarget && zg(this.j(), a.relatedTarget) || !this.dispatchEvent('leave') || (nj(this, 4) && jj(this, !1), nj(this, 2) && kj(this, !1));
  };
  v.Nc = z;
  v.Lc = function(a) {
    this.isEnabled() && (nj(this, 2) && kj(this, !0), !Ih(a) || K && Xe && a.ctrlKey || (nj(this, 4) && jj(this, !0), this.a && this.a.Fe(this) && this.j().focus()));
    this.$c || !Ih(a) || K && Xe && a.ctrlKey || a.b();
  };
  v.dc = function(a) {
    this.isEnabled() && (nj(this, 2) && kj(this, !0), this.fc() && this.mc(a) && nj(this, 4) && jj(this, !1));
  };
  v.lg = function(a) {
  ...
  if (!vc(Ei)) throw Error('Invalid renderer class ' + Ei);
  var oj = xc(W);
  ej[oj] = Ei;
  ...
  function qj(a, b) {
    if (!pj) return a.button = 0, a.type = b, a;
  ...
  v.Oa = function(a, b) {
    ...
    a:{
      ...
      if (c && Lf(c, d) && (c = a.b.bg(c), d = this.da() + '-inner-box', c && Lf(c, d))) {
        c = !0;
        break a;
      }
      c = !1;
  ...
  var xj = 'StopIteration' in x ? x.StopIteration : { message: 'StopIteration', stack: '' };
  ...
  function zj(a) {
    if (a instanceof yj) return a;
    if (typeof a.Ja == p) return a.Ja(!1);
    if (uc(a)) {
      var b = 0, c = new yj;
      c.next = function() {
        for (; ;) {
          if (b >= a.length) throw xj;
  ...
  function Bj(a, b) {
    ...
    } else if (a) if (a instanceof Bj) for (c = a.Ra(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d])); else for (d in a) this.set(d, a[d]);
  }
  ...
  v.remove = function(a) {
    return Ej(this.b, a) ? (delete this.b[a], this.c--, this.f++, this.a.length > 2 * this.c && Cj(this), !0) : !1;
  };
  ...
  function Cj(a) {
    ...
    if (a.c != a.a.length) {
      var e = {};
      for (c = b = 0; b < a.a.length;) d = a.a[b], Ej(e, d) || (a.a[c++] = d, e[d] = 1), b++;
      a.a.length = c;
    }
  }
  ...
  v.set = function(a, b) {
    Ej(this.b, a) || (this.c++, this.a.push(a), this.f++);
    this.b[a] = b;
  };
  ...
  function Kj(a) {
    ...
    if (a instanceof Kj) {
      ...
      var c = new Nj;
      c.c = b.c;
      b.a && (c.a = new Bj(b.a), c.b = b.b);
      Oj(this, c);
      this.g = a.g;
    } else {
      a && (b = String(a).match(Ij)) ? (this.b = !1, Lj(this, b[1] || '', !0), this.s = Pj(b[2] || ''), this.f = Pj(b[3] || '', !0), Mj(this, b[4]), this.h = Pj(b[5] || '', !0), Oj(this, b[6] || '', !0), this.g = Pj(b[7] || '')) : (this.b = !1, this.a = new Nj(null, this.b));
    }
  }
  ...
  Kj.prototype.toString = function() {
    ...
    b && a.push(Qj(b, Rj, !0), ':');
    var c = this.f;
    if (c || 'file' == b) a.push('//'), (b = this.s) && a.push(Qj(b, Rj, !0), '@'), a.push(Fe(c).replace(/%25([0-9a-fA-F]{2})/g, '%$1')), c = this.l, null != c && a.push(':', String(c));
    if (c = this.h) this.f && '/' != c.charAt(0) && a.push('/'), a.push(Qj(c, '/' == c.charAt(0) ? Sj : Tj, !0));
  ...
  function Oj(a, b, c) {
    b instanceof Nj ? (a.a = b, Vj(a.a, a.b)) : (c || (b = Qj(b, Wj)), a.a = new Nj(b, a.b));
  }
  ...
  function Qj(a, b, c) {
    return y(a) ? (a = encodeURI(a).replace(b, Xj), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, '%$1')), a) : null;
  }
  ...
  function Yj(a) {
    a.a || (a.a = new Bj, a.b = 0, a.c && Jj(a.c, function(b, c) {
      a.add(Ge(b), c);
    }));
  }
  ...
  v.remove = function(a) {
    Yj(this);
    a = Zj(this, a);
    return Dj(this.a, a) ? (this.c = null, this.b = this.b - this.a.get(a).length, this.a.remove(a)) : !1;
  };
  ...
  v.Ra = function() {
    Yj(this);
    for (var a = this.a.Da(), b = this.a.Ra(), c = [], d = 0; d < b.length; d++) for (var e = a[d], f = 0; f < e.length; f++) c.push(b[d]);
    return c;
  };
  v.Da = function(a) {
    Yj(this);
  ...
  function bk(a, b, c) {
    a.remove(b);
    0 < c.length && (a.c = null, a.a.set(Zj(a, b), Tc(c)), a.b = a.b + c.length);
  }
  ...
  function Vj(a, b) {
    b && !a.f && (Yj(a), a.c = null, a.a.forEach(function(c, d) {
      var e = d.toLowerCase();
      d != e && (this.remove(d), bk(this, e, c));
    }, a));
    a.f = b;
  }
  ...
  function hk(a) {
    if (a.Ib !== ck) throw Error('Sanitized content was not of kind HTML.');
  ...
  function wk(a) {
    mk(a, dk) || mk(a, ek) ? a = xk(a) : a instanceof Fd ? a = xk(Id(a).toString()) : a instanceof od ? a = xk(rd(a).toString()) : (a = String(a), a = yk.test(a) ? a.replace(zk, Ak) : Aa);
    return a;
  }

  function Bk(a) {
    mk(a, dk) || mk(a, ek) ? a = xk(a) : a instanceof Fd ? a = xk(Id(a).toString()) : a instanceof od ? a = xk(rd(a).toString()) : (a = String(a), a = Ck.test(a) ? a.replace(zk, Ak) : Aa);
    return a;
  }
  ...
  function Ek(a) {
    mk(a, fk) ? a = rk(a.ea()) : null == a ? a = '' : a instanceof Ld ? a = rk(Nd(a)) : a instanceof Xd ? a = rk(Zd(a)) : (a = String(a), a = Fk.test(a) ? a : 'zSoyz');
    return a;
  }
  ...
  var uk = /[\x00\x22\x27\x3c\x3e]/g, Kk = /[\x00\x08-\x0d\x22\x26-\x2a\/\x3a-\x3e@\\\x7b\x7d\x85\xa0\u2028\u2029]/g,
  ...
  function Vk() {
    if (x.Promise && x.Promise.resolve) {
      ...
      Uk = function() {
        var b = Yk;
        !vc(x.setImmediate) || x.Window && x.Window.prototype && !H(la) && x.Window.prototype.setImmediate == x.setImmediate ? (Ok || (Ok = Pk()), Ok(b)) : x.setImmediate(b);
      };
    }
  }
    ...
    if (0 == a.a) {
      if (a.c) {
        ...
        if (c.b) {
          ...
          e && (0 == c.a && 1 == d ? jl(c, b) : (f ? (d = f, d.next == c.f && (c.f = d), d.next = d.next.next) : kl(c), ll(c, e, 3, b)));
        }
        a.c = null;
      } else {
        al(a, 3, b);
  ...
  function sl(a, b, c) {
    if (vc(a)) c && (a = C(a, c)); else if (a && typeof a.handleEvent == p) a = C(a.handleEvent, a); else throw Error('Invalid listener argument');
  ...
  var vl = function() {
    ...
    return Xe ? (a = /10[_.][0-9_.]+/, (a = a.exec(ae)) ? a[0].replace(/_/g, '.') : '10') : Ze ? (a = /Android\s+([^\);]+)(\)|;)/, (a = a.exec(ae)) ? a[1] : '') : $e || af || bf ? (a = /(?:iPhone|CPU)\s+OS\s+(\S+)/, (a = a.exec(ae)) ? a[1].replace(/_/g, '.') : '') : '';
  }();
  ...
  var xl = function() {
    if (pf) return wl(/Firefox\/([0-9.]+)/);
    if (I || Ue || Te) return kf;
    if (tf) return Pe() ? wl(/CriOS\/([0-9.]+)/) : wl(/Chrome\/([0-9.]+)/);
    if (uf && !Pe()) return wl(/Version\/([0-9.]+)/);
    if (qf || rf) {
      var a = /Version\/(\S+).*Mobile\/(\S+)/.exec(ae);
      if (a) return a[1] + '.' + a[2];
    } else if (sf) return (a = wl(/Android\s+([0-9.]+)/)) ? a : wl(/Version\/([0-9.]+)/);
    return '';
  }();
  ...
  function yl(a, b, c, d, e, f, h, k, l) {
    ...
    if (r = bh(a)) {
      ...
      if (r <= F) {
        ...
        E <= w && (n.left = r, n.top = E, n.width = F - r, n.height = w - E);
      }
    }
    r = Xf(a);
    E = Xf(c);
    ...
    if (h) if (l) var ca = l; else if (ca = bh(c)) ca.top -= m.y, ca.right -= m.x, ca.bottom -= m.y, ca.left -= m.x;
  ...
  function Bl(a, b, c, d, e, f, h) {
    ...
    c == h || c && h && c.width == h.width && c.height == h.height || (c = h, a = gg(Xf(O(b)).a), !I || L('10') || a && L('8') ? nh(b, c, La) : (h = b.style, a ? (a = oh(b), b = ph(b), h.pixelWidth = c.width - b.left - a.left - a.right - b.right, h.pixelHeight = c.height - b.top - a.top - a.bottom - b.bottom) : (h.pixelWidth = c.width, h.pixelHeight = c.height)));
    return e;
  }
  ...
  v.send = function(a, b, c, d) {
    ...
    try {
      this.xa(), this.Re = !0, this.N.open(b, String(a), !0), this.Re = !1;
    } catch (f) {
      this.xa();
      this.jd(5, f);
      return;
    ...
    try {
      Pl(this), 0 < this.Vc && (this.Df = Ql(this.N), this.xa(), this.Df ? (this.N.timeout = this.Vc, this.N.ontimeout = C(this.Eb, this)) : this.be = sl(this.Eb, this.Vc, this)), this.xa(), this.Jd = !0, this.N.send(a),
        this.Jd = !1;
    } catch (f) {
      this.xa(), this.jd(5, f);
    }
  ...
  v.Eb = function() {
    'undefined' != typeof oc && this.N && (this.Od = 'Timed out after ' + this.Vc + 'ms, aborting', this.Ha = 8, this.xa(), this.dispatchEvent('timeout'), this.abort(8));
  };
  v.jd = function(a, b) {
    this.ma = !1;
  ...
  function Rl(a) {
    a.se || (a.se = !0, a.dispatchEvent(Ua), a.dispatchEvent('error'));
  }

  v.abort = function(a) {
    this.N && this.ma && (this.xa(), this.ma = !1, this.Qb = !0, this.N.abort(), this.Qb = !1, this.Ha = a || 7, this.dispatchEvent(Ua), this.dispatchEvent('abort'), Sl(this));
  };
  v.F = function() {
    this.N && (this.ma && (this.ma = !1, this.Qb = !0, this.N.abort(), this.Qb = !1), Sl(this, !0));
    Jl.m.F.call(this);
  };
  v.Kg = function() {
  ...
  function Tl(a) {
    if (a.ma && 'undefined' != typeof oc) {
      if (a.ee[1] && 4 == Ul(a) && 2 == a.xa()) {
        ...
        sl(a.Kg, 0, a);
      } else if (a.dispatchEvent(Pb), a.Ld()) {
        a.xa();
        a.ma = !1;
        try {
          if (a.Pc()) {
            a.dispatchEvent(Ua), a.dispatchEvent('success');
          } else {
            a.Ha = 6;
            try {
  ...
  v.Pc = function() {
    ...
    if (!b) {
      if (a = 0 === a) a = String(this.rb).match(Ij)[1] || null, !a && x.self && x.self.location && (a = x.self.location.protocol, a = a.substr(0, a.length - 1)), a = !Kl.test(a ? a.toLowerCase() : '');
      b = a;
    }
    return b;
  };
  ...
  v.getResponseHeader = function(a) {
    if (this.N && this.Ld()) return a = this.N.getResponseHeader(a), null === a ? void 0 : a;
  };
  ...
  function Wl(a, b, c) {
    ...
    switch (A(b)) {
      case Ub:
        return a = b, 64 < a.length && (null == c || !c) && (a = a.substr(0, 64)), Fe(a);
      case Fb:
        return '' + b;
      case 'boolean':
        return b ? '1' : '0';
      case Ga:
        var d = [], e;
        for (e in b) d.push(Wl(a, b[e], c));
        return d.join(',');
      case Gb:
        d = [];
        for (e in b) d.push(Xl(a, e, b[e], c));
        return d.join(',');
      default:
        return '';
    }
  ...
  function am(a, b) {
    ...
    if (A(1) == Gb) {
      A(d) != Gb && (d = {});
      for (var e in 1) d[e] = bm(e in d ? d[e] : null, 1[e]);
    } else {
      d = bm(d, 1);
    }
    a.a[b] = [c, d];
  ...
  function nm(a, b) {
    var c = a[b - 1];
    if (null == c || om(c)) a = a[a.length - 1], om(a) && (c = a[b]);
    return c;
  }
  ...
  function pm(a, b) {
    return a === b ? !0 : Oc(a, function(c, d) {
      ...
      if (om(c)) {
        for (var e in c) if (null == nm(a, +e)) return !1;
        return !0;
      }
  ...
  function Om(a) {
    if (!a.c) return !0;
    for (var b = 0; b < a.a.length; ++b) if (a.a[b].target === a && a.a[b].jh == a.b) return a.a[b].ready;
    return !0;
  }
  ...
  Gm.prototype.K = function(a) {
    ...
    a = this.g;
    if (a == Im) return this.stop(), this.h && this.h.call(this.o, this, this.B), !1;
    this.f = !0;
    try {
  ...
  var Rm = Wc(function() {
    if (I) return L('10.0');
    var a = document.createElement(g), b = K ? '-webkit' : J ? '-moz' : I ? '-ms' : Te ? '-o' : null,
      c = { transition: Hb };
    b && (c[b + '-transition'] = Hb);
    b = qe(Za, { style: c });
    xe(a, b);
  ...
  v.play = function() {
    ...
    this.b = D();
    this.a = 1;
    if (Rm()) return P(this.A, this.s), this.h = sl(this.ej, void 0, this), !0;
    this.Af(!1);
    return !1;
  };
  v.ej = function() {
  ...
  v.I = function(a) {
    ...
    if (a) {
      if (!this.hc && this.Ie()) {
        ...
        this.pc == Yb ? (this.A.style.visibility = dc, Q(this.A, !0)) : this.pc ==
          Eb && this.ob();
        this.hc = !0;
        this.Xe = D();
        this.ua ? (Vh(this.ua, 'end', this.Lg, !1, this), this.ua.play()) : this.Lg();
      }
    } else {
      Vm(this);
    }
  ...
  function Vm(a, b) {
    a.hc && a.dispatchEvent({
      type: 'beforehide',
      target: b,
    }) && (a.h && mi(a.h), a.hc = !1, D(), a.qa ? (Vh(a.qa, 'end', Cc(a.Sf, b), !1, a), a.qa.play()) : a.Sf(b));
  }
  ...
  v.Jg = function(a) {
    ...
    if ('undefined' != typeof document.activeElement) {
      if (a = b.activeElement, !a || zg(this.A, a) || 'BODY' == a.tagName) return;
  ...
  Xm.prototype.ob = function() {
    if (this.s) {
      var a = !this.isVisible() && this.pc != Eb, b = this.j();
  ...
  Ym.prototype.l = function(a) {
    if (this.a != a && (0 != this.a || !(this.isVisible() && 1 == a || !this.isVisible() && -1 == a))) {
      ...
      if (Rm()) {
        ...
        this.a = a;
        this.b = new Sm(this.c, b, { left: d + 'px' }, { left: c + 'px' }, 'left ' + b + 's');
        this.b.play();
        Vh(this.b, $a, C(this.g, this));
        -1 == a ? Vh(this.b, $a, C(this.I, this, !1)) : this.I(!0);
      } else {
        P(this.c,
          'left', c + 'px'), this.I(1 == a ? !0 : !1);
      }
    }
  };
  Ym.prototype.g = function() {
    0 != this.a && (this.b.stop(), sl(C(di, this, this.b)), this.a = 0, this.b = null);
  };
  ...
  function en() {
    ...
    this.b = null;
    this.A && (sg(this.a, this.A), fn(this));
  }
  ...
  function gn(a, b, c, d, e) {
    ...
    if (b != c || e) {
      ...
      b < c && (h = d.substring(b, c), f = kg(ua, f), hn(f, h, b, e), a.a.appendChild(f));
      c < d.length && (h = d.substring(c), hn(a.a, h, c, e));
    }
  }

  function fn(a) {
    var b = a.A;
    var c = O(b), d = I && b.currentStyle;
    d && gg(Xf(c).a) && d.width != Ha && d.height != Ha && !d.boxSizing ? (c = qh(b, d.width, 'width', 'pixelWidth'), b = qh(b, d.height, 'height', 'pixelHeight'), b = new Wf(c, b)) : (d = lh(b), c = oh(b), b = ph(b), b = new Wf(d.width - b.left - c.left - c.right - b.right, d.height - b.top - c.top - c.bottom - b.bottom));
    mh(a.a, b);
    c = ch(a.A);
    b = a.a;
    d = c.x;
  ...
  function ln(a, b, c, d) {
    if (a.node = b) a.c = qc(c) ? c : 1 != a.node.nodeType ? 0 : a.f ? -1 : 1;
    qc(d) && (a.depth = d);
  }
  ...
  kn.prototype.next = function() {
    if (this.o) {
      if (!this.node || this.C && 0 == this.depth) throw xj;
      var a = this.node;
      var b = this.f ? -1 : 1;
      if (this.c == b) {
  ...
  kn.prototype.splice = function(a) {
    ...
    for (var d = c.length - 1; 0 <= d; d--) tg(c[d], b);
    ug(b);
  };
  ...
  rn.prototype.g = function() {
    rn.m.g.apply(this);
    if (zg(this.node, this.h ? this.a : this.b)) throw xj;
  };
  ...
  function vn(a) {
    ...
    if (3 == a.nodeType) {
      ...
      for (var c, d = a; (c = d.firstChild) && wn(c);) d = c;
      b.setStart(d, 0);
      for (d = a; (c = d.lastChild) && wn(c);) d = c;
      b.setEnd(d, 1 == d.nodeType ? d.childNodes.length : d.length);
    } else {
      c = a.parentNode, a = Jc(c.childNodes, a), b.setStart(c, a), b.setEnd(c, a + 1);
    }
    return b;
  }
  ...
  yn.prototype.Rc = function(a, b) {
    !b || this.Ta() ? yn.m.Rc.call(this, a, b) : (a.collapse(this.mb(), this.vb()), a.extend(this.Sa(), this.nb()));
  };
  ...
  function An(a) {
    ...
    if (1 == a.nodeType) {
      b.moveToElementText(a), wn(a) && !a.childNodes.length && b.collapse(!1);
    } else {
  ...
  v.Ae = function() {
    if (!this.h) {
      ...
      for (; 1 == c.childNodes.length && c.innerText == Bn(c.firstChild) && wn(c.firstChild);) c = c.firstChild;
  ...
  function Cn(a, b) {
    for (var c = b.childNodes, d = 0, e = c.length; d < e; d++) {
      var f = c[d];
      if (wn(f)) {
        var h = An(f), k = h.htmlText != f.outerHTML;
        if (a.Ta() && k ? 0 <= a.ab(h, 1, 1) && 0 >= a.ab(h, 1, 0) : a.c.inRange(h)) return Cn(a, f);
      }
    }
    return b;
  }
  ...
  v.Sa = function() {
    this.a || (this.a = Dn(this, 1), this.Ta() && (this.b = this.a));
    return this.a;
  };
  v.nb = function() {
    0 > this.f && (this.f = En(this, 1), this.Ta() && (this.g = this.f));
    return this.f;
  };
  v.mb = function() {
  ...
  v.vb = function() {
    ...
    0 > this.g && (this.g = En(this, 0), this.Ta() && (this.f = this.g));
    return this.g;
  };
  v.ab = function(a, b, c) {
  ...
  function Dn(a, b, c) {
    ...
    for (var d = 1 == b, e = 0, f = c.childNodes.length; e < f; e++) {
      ...
      if (a.Ta()) {
        ...
        if (0 > a.ab(m, 1, 0) && 0 < a.ab(m, 0, 1)) return Dn(a, b, k);
      }
    }
    return c;
  }
  ...
  function En(a, b) {
    ...
    if (1 == d.nodeType) {
      ...
      for (var e = d.length, f = c ? 1 : -1, h = c ? 0 : e - 1; 0 <= h && h < e; h += f) {
        var k = d[h];
        if (!wn(k) && 0 == a.c.compareEndPoints((1 == b ? 'Start' : 'End') + 'To' + (1 == b ? 'Start' : 'End'), Fn(k).Cc())) return c ? h : h + 1;
      }
      return -1 == h ? 0 : h;
    }
    a = a.c.duplicate();
  ...
  function Fn(a) {
    if (I && !mf(9)) {
      ...
      if (wn(a)) {
        ...
        b.a = b.b = b.h = a.parentNode, b.f = Jc(b.h.childNodes, a), b.g = b.f + 1;
      }
      a = b;
    } else {
  ...
  function Ln(a) {
    ...
    if (!(b = a.h)) {
      ...
      if (I && !mf(9)) {
        ...
        var n = An(f);
        h && n.move(Pa, h);
        f == k && h == l ? n.collapse(!0) : (m && n.collapse(!1), m = !1, 1 == k.nodeType && (k = (h = k.childNodes[l]) || k.lastChild || k, l = 0, m = !h), f = An(k), f.collapse(!m), l && f.moveEnd(Pa, l), n.setEndPoint('EndToEnd', f));
        l = new zn(n, O(b));
        l.a = b;
        l.f = c;
        l.b = d;
        ...
        b = K ? new Hn(xn(b, c, d, e)) : J ? new yn(xn(b, c, d, e)) : Te ? new Gn(xn(b,
          c, d, e)) : new un(xn(b, c, d, e));
      }
      b = a.h = b;
    }
    return b;
  ...
  function Pn(a) {
    a.c || (a.c = On(a).concat(), a.c.sort(function(b, c) {
  ...
  function Qn(a) {
    ...
    a && (this.h = Pn(a), this.a = this.h.shift(), this.b = Ic(this.h) || this.a);
  ...
  function Sn(a) {
    a.b || (a.b = on(a), a.b.sort(function(b, c) {
      var d = b.Ma();
      b = b.Na();
      var e = c.Ma();
      c = c.Na();
  ...
  v.select = function() {
    ...
    a.removeAllRanges();
    for (var b = 0, c = this.Gc(); b < c; b++) a.addRange(this.Zb(b).we());
  };
  ...
  Un.prototype.next = function() {
    try {
      ...
      if (c !== xj || this.a.length - 1 == this.b) throw c;
      this.b++;
      return this.next();
    }
  };
  ...
  function Wn(a) {
    ...
    (a = c) && a.addElement ? (b = new Nn, b.a = a, a = b) : a = Kn(In(a), b);
    return a;
  }
  ...
  function Tn(a, b, c, d) {
    if (a == c) return d < b;
    var e;
    if (1 == a.nodeType && b) if (e = a.childNodes[b]) a = e, b = 0; else if (zg(a, c)) return !0;
    if (1 == c.nodeType && d) if (e = c.childNodes[d]) c = e, d = 0; else if (zg(c, a)) return !1;
    return 0 < (Ag(a, c) || b - d);
  };
  ...
  v.Oa = function(a, b) {
    var c = wg(b), d = Zn(this, 2);
    c && Lf(c, d) || b.appendChild($n(this, b.childNodes, a.b));
    Lf(b, kb) && (a.sa(16, !0), a && b && ao(this, a, b, !0));
    return Yn.m.Oa.call(this, a, b);
  };
  v.Ic = function(a, b) {
    var c = this.zb(a), d = bo(this, a) ? c.firstChild : null;
  ...
  function bo(a, b) {
    return (b = a.zb(b)) ? (b = b.firstChild, a = Zn(a, 1), !!b && yg(b) && Lf(b, a)) : !1;
  }

  function ao(a, b, c, d) {
    Li(a, c, b.Fc());
    Ni(a, b, c);
    d != bo(a, c) && (d ? M(c, kb) : Nf(c, kb), c = a.zb(c), d ? (a = Zn(a, 1), c.insertBefore(b.b.D(g, a), c.firstChild || null)) : c.removeChild(c.firstChild));
  }
  ...
  v.dc = function(a) {
    ...
    if (b) {
      var c = b.J;
      b.J = null;
      if (b = c && qc(a.clientX)) b = new N(a.clientX, a.clientY), b = c == b ? !0 : c && b ? c.x == b.x && c.y == b.y : !1;
      if (b) return;
    }
    co.m.dc.call(this, a);
  };
  ...
  function jo(a, b, c) {
    if (c) {
      for (var d = c.firstChild, e; d && d.parentNode == c;) {
        ...
        if (1 == d.nodeType) {
          var f = a.xe(d);
          f && (f.A = d, b.isEnabled() || f.ka(!1), b.rc(f), yi(f, d));
        } else {
  ...
  oo.prototype.b = function(a, b, c) {
    ...
    if (d & 496) {
      ...
      d & 496 && (e = po(d, e), b = po(d, b), yl(this.c, e, a, b, null, c, this.l, void 0, this.g));
    }
  };
  ...
  ro.prototype.b = function(a, b, c) {
    ...
    var f = b, h = Bl(e, a, f, c, d, 10, void 0);
    if (0 != (h & 496)) {
      if (h & 16 || h & 32) f ^= 4;
      if (h & 64 || h & 128) f ^= 1;
  ...
  function uo(a, b) {
    if (a.Jb) {
      ...
      a.ic = b;
      var e = to(a);
      d && (a.ic = c, vo(a, !1), a.ic = b, Wi(wo(a), e), vo(a, !0));
    } else {
  ...
  v.oi = function(a) {
    (a = a.target) && a != this.pa && a.wb() == this && (this.pa && mj(this.pa, !1), this.pa = a);
  };
  v.ci = function(a) {
    a.target == this.pa && (this.pa = null);
    var b = this.j(), c = a.target.j();
    b && a.target.V & 2 && c && (a = '', c && (a = c.id), wh(b, Da, a));
  };
  v.Uh = function(a) {
    this.xb && (this.jc = !0);
    var b = to(this);
  ...
  v.Ga = function(a) {
    return this.isEnabled() && this.isVisible() && (0 != Ai(this) || this.ic) && this.Ee(a) ? (a.b(), a.stopPropagation(), !0) : !1;
  };
  v.Ee = function(a) {
    var b = yo(this);
    ...
    switch (a.keyCode) {
      case 27:
        if (this.Jb) to(this).blur(); else return !1;
        break;
      case 36:
        zo(this);
        break;
      case 35:
        ...
        break;
      case 38:
        if (this.Sb == cc) Bo(this); else return !1;
        break;
      case 37:
        if (this.Sb == sb) Ci(this) ? Co(this) : Bo(this); else return !1;
        break;
      case 40:
        if (this.Sb == cc) Co(this); else return !1;
        break;
      case 39:
        if (this.Sb == sb) {
          Ci(this) ?
  ...
  v.removeChild = function(a, b) {
    if (a = y(a) ? wi(this, a) : a) {
      var c = Di(this, a);
      -1 != c && (c == this.ha ? (kj(a, !1), this.ha = -1) : c < this.ha && this.ha--);
      var d = a.j();
  ...
  v.I = function(a, b) {
    if (b || this.ga != a && this.dispatchEvent(a ? 'show' : rb)) {
      this.ga = a;
      var c = this.j();
      c && (Q(c, a), this.Jb && fo(to(this), this.xb && this.ga), b || this.dispatchEvent(this.ga ? 'aftershow' : 'afterhide'));
      return !0;
    }
    return !1;
  };
  v.isEnabled = t('xb');
  v.ka = function(a) {
    this.xb != a && this.dispatchEvent(a ? 'enable' : 'disable') && (a ? (this.xb = !0, zi(this, function(b) {
      b.kh ? delete b.kh : b.ka(!0);
    })) : (zi(this, function(b) {
      b.isEnabled() ? b.ka(!1) : b.kh = !0;
    }), this.jc = this.xb = !1), this.Jb && fo(to(this), a && this.ga));
  };
  ...
  v.S = function(a) {
    for (var b = this.yb, c = bg(this.b.a, g, b.ud() + '-content', a), d = c.length, e = 0; e < d; e++) jo(b, this, c[e]);
    Ho.m.S.call(this, a);
  };
  v.Ee = function(a) {
    var b = Ho.m.Ee.call(this, a);
    b || zi(this, function(c) {
      !b && c.Sh && c.Hg == a.keyCode && (this.isEnabled() && this.Cb(Di(this, c)), b = c.Ga(a));
    }, this);
    return b;
  };
  v.Cb = function(a) {
    ...
    if (b) {
      ...
      var c = b.j();
      b = a || ig(document);
      var d = ch(c), e = ch(b), f = ph(b);
      if (b == ig(document)) {
        var h = d.x - b.scrollLeft;
        d = d.y - b.scrollTop;
        I && !mf(10) && (h += f.left, d += f.top);
      } else {
        h = d.x - e.x - f.left, d = d.y - e.y - f.top;
      }
      c = fh(c);
  ...
  function Jo(a, b, c, d, e, f) {
    b && Dj(a.a, xc(b)) || (c = a.pe(b, c, d, e, f), a.U && a.ad(c), b = Cc(a.Yi, b), a.j() && U(a).w(a.j(), xb, b));
  }
  ...
  v.Yi = function(a, b) {
    if (27 == b.keyCode) {
      ...
      var c = new Fh(b.a, a);
      c.target = a;
      if (32 == b.keyCode || 13 == b.keyCode) Kh(a) ? oi(a, xb, !1, c) : ei(a, xb, !1, c);
      32 == b.keyCode && this.pb();
    }
  };
  v.pe = function(a, b, c, d, e) {
    if (!a) return null;
    b = { A: a, bh: b, Ui: c, Ac: d ? Wa : Ab, $e: e };
    this.a.set(xc(a), b);
    return b;
  };
  v.ad = function(a) {
  ...
  v.gd = function() {
    if (this.U) for (var a = this.a.Ra(), b = 0; b < a.length; b++) this.re(this.a.get(a[b]));
    Fj(this.a);
  };
  v.re = function(a) {
  ...
  v.yd = function(a, b, c) {
    ...
    f && this.ih ? this.pb() : (this.Ca = e || null, this.dispatchEvent('beforeshow') && (d = 'undefined' != typeof d ? d : 8, a || (this.j().style.visibility = qb), Q(this.j(), !0), b.b(this.j(), d, c), a || (this.j().style.visibility = dc), this.Cb(-1), this.I(!0)));
  };
  v.pb = function() {
    this.isVisible() && (this.I(!1), this.isVisible() || (this.Bg = D(), this.Ca = null));
  };
  v.ef = function() {
    this.pb();
  };
  ...
  v.F = function() {
    Io.m.F.call(this);
    this.a && (Fj(this.a), delete this.a);
  };
  ...
  function Po(a, b, c) {
    ...
    Xm.call(this, this.ca.D(g, { style: 'position:absolute;display:none;' }));
    this.Gb = new N(1, 1);
    this.B = new No;
    this.G = null;
    a && Qo(this, a);
  ...
  function So(a, b) {
    if (b) {
      b = Zf(document, b), To(a, b), a.B.remove(b);
    } else {
      for (var c = a.B.Da(), d = 0; b = c[d]; d++) To(a, b);
      Fj(a.B.a);
    }
  }
  ...
  v.bc = function(a) {
    ...
    b && ug(b);
    Po.m.bc.call(this, a);
    a ? (b = this.ca.a.body, b.insertBefore(a, b.lastChild), yh(this.G), this.G = new Lo(this.j()), xh(this, Cc(yh, this.G)), S(this.G, db, this.Yb, void 0, this), S(this.G, eb, this.Yd, void 0, this)) : (yh(this.G), this.G = null);
  };
  v.Mc = function() {
    return Mg(this.j());
  };
  ...
  v.Ie = function() {
    if (!Tm.prototype.Ie.call(this)) return !1;
    if (this.b) for (var a, b = 0; a = Ro[b]; b++) zg(a.j(), this.b) || a.I(!1);
  ...
  v.hf = function() {
    Rc(Ro, this);
    for (var a = this.j(), b, c = 0; b = Ro[c]; c++) b.b && zg(a, b.b) && b.I(!1);
    this.Zc && this.Zc.Yd();
  ...
  v.cf = function(a, b) {
    this.b == a && this.B.contains(this.b) && (this.Ia || !this.Mf ? (this.I(!1), this.isVisible() || (this.b = a, this.s = b || new Wo(Uf(this.Gb)), this.isVisible() && this.ob(), this.I(!0))) : this.b = void 0);
    this.L = void 0;
  };
  v.Ti = function(a) {
    this.la = void 0;
  ...
  v.Je = function(a) {
    ...
    this.za = b;
    this.Yb();
    b != this.b && (this.b = b, Zo(this, b), $o(this), Xo(this, a));
  };
  ...
  function $o(a) {
    if (a.b) for (var b, c = 0; b = Ro[c]; c++) zg(b.j(), a.b) && (b.Yc = a, a.Zc = b);
  }

  v.cc = function(a) {
    var b = Yo(this, a.target), c = Yo(this, a.relatedTarget);
    b != c && (b == this.za && (this.za = null), Vo(this), this.Ia = !1, !this.isVisible() || a.relatedTarget && zg(this.j(), a.relatedTarget) ? this.b = void 0 : this.Yd());
  };
  v.Gd = function() {
    var a = this.j();
  ...
  v.Fd = function(a) {
    var b = this.j();
    this.za != b || a.relatedTarget && zg(b, a.relatedTarget) || (this.za = null, this.Yd());
  };
  ...
  v.Yb = function() {
    this.la && (tl(this.la), this.la = void 0);
  };
  v.F = function() {
    this.I(!1);
    Vo(this);
  ...
  v.D = function() {
    bp.m.D.call(this);
    for (var a = 0; a < this.f; ++a) this.rc(new co(''), !0);
  };
  v.fa = function(a) {
    bp.m.fa.call(this, a);
    M(this.j(), 'alt-menu');
  ...
  v.I = function(a, b) {
    var c = this.Ca;
    this.L = c;
    a && null != c ? (ep(this, c), am(this.C, 'altshow'), Am(this.va, 207)) : null != this.l && gn(this.l, 0, 0);
  ...
  v.Ga = function(a) {
    ...
    if (!b && (37 == a.keyCode || 39 == a.keyCode)) {
      var c = ih(this.Ca.parentNode.parentNode), d = null;
      if (!c && 37 == a.keyCode || c && 39 == a.keyCode) d = !1;
      if (!c && 39 == a.keyCode || c && 37 == a.keyCode) d = !0;
      if (this.je(d) && (c = this.Ca, (c = d ? pc(c.nextElementSibling) ? c.nextElementSibling : xg(c.nextSibling, !0) : pc(c.previousElementSibling) ? c.previousElementSibling : xg(c.previousSibling, !1)) && c != this.Ca)) {
        return this.pb(), this.Yg(d),
          this.yd(c ? this.a.get(xc(c)) : null, 0, 0), fp(this), a.b(), a.stopPropagation(), !0;
      }
    }
    return b;
  };
  v.yd = function(a, b, c) {
    ...
    if (this.o) for (var d = 0; d < this.g.length; d++) gp(this, d), Gg(this.g[d].c, '...');
    this.wf(a.A);
    bp.m.yd.call(this, a, b, c);
  };

  function hp(a, b, c) {
    !a.o || b >= a.f || '' == c || (Gg(a.g[b].c, c), gp(a, b));
  }
  ...
  v.Oc = function(a) {
    bp.m.Oc.call(this, a);
    var b = this.Ca;
    null != b && (am(this.C, 'altmenuhl'), Am(this.va, 209), ep(this, b), a = this.nd(a.target), -1 != a && a != this.f && (tl(this.H[a]), this.H[a] = sl(this.Ri, 300, this), this.o && (b = this.g[a], ih(this.Ca.parentNode.parentNode) ? (M(b.j(), Qb), P(b.j(), Ya, Qb)) : (Nf(b.j(), Qb), P(b.j(), Ya, '')), gp(this, a), tl(b.f), 0 == b.a ? b.f = sl(C(b.l, b, 1), 300) : b.l(1))));
  };
  v.Ri = function() {
  ...
  v.Pe = function(a) {
    bp.m.Pe.call(this, a);
    a = this.nd(a.target);
    -1 != a && a != this.f && (tl(this.H[a]), this.o && this.g[a].o());
  };
  v.nd = function(a) {
    return Di(this, a);
  };
  ...
  function ep(a, b) {
    if (null != a.l && (b = a.h.get(xc(b))) && (a = a.l, a.b)) {
      for (var c = a.A && (a.A.value || Mg(a.A)), d = -1, e = -1, f = !1, h = 0; h < Y(a.b, 5); h++) {
        var k = dn(a.b, h);
        if (0 != Y(k, 2) && (0 == vm(k, 5) && (f = c.indexOf(wm(k, 4), e + 1), 0 <= f ? (d = f, e = d + wm(k, 4).length, f = !0) : f = !1), dn(a.b, h).Fb() == b.Fb())) {
          if (f) {
            c = [];
            for (e = 0; e < Y(b, 3); ++e) {
              c.push({
            ...
            d = c.indexOf(wm(b, 0)), 0 <= d && gn(a, d, d + wm(b, 0).length);
          }
          break;
        }
      }
  ...
  function ip(a, b) {
    b ? Aj(a.a.Ja(!1), function(c) {
      '' == this.b.dg(c.A) && (M(c.A, Zb), this.b.ib(c.A, '_'));
      return !0;
    }, a) : Aj(a.a.Ja(!1), function(c) {
      Lf(c.A, Zb) && (Nf(c.A, Zb), this.b.ib(c.A, ''));
      return !0;
    }, a);
  }

  v.ug = function(a) {
    !Xn() && this.isEnabled() && (M(a.target, $b), ep(this, a.target), ip(this, !0), am(this.C, 'althighlight'), Am(this.va, 206));
  };
  v.Dd = function(a) {
    Nf(a.target, $b);
  ...
  v.sg = function(a) {
    Xn() || (this.Dd(a), Kn(Fn(a.target), void 0).select());
  };
  ...
  v.qe = function(a) {
    ...
    if (null != this.c) {
      ...
      yg(c) && !pg(c) && (f = c.parentNode, b = Jc(f.childNodes, c), c = f);
  ...
  v.mg = function(a) {
    for (var b = 0; b < this.f; ++b) Bi(this, b).I(!1);
    if (13 == a.keyCode || 3 == a.keyCode) return null === yo(this) ? (this.pb(), a.stopPropagation(), a.b(), !0) : !1;
    null === yo(this) || !Qi(a) && 37 != a.keyCode && 39 != a.keyCode || (this.Ca.focus(), this.Cb(Di(this, null)));
    return !1;
  };
  v.je = function(a) {
    var b = Vn();
  ...
  v.Ga = function(a) {
    return 9 == a.keyCode ? (this.c.V & 2 ? (to(this) == this.c.j().firstChild ? uo(this, this.c.j().firstChild.nextSibling) : uo(this, this.c.j().firstChild), to(this).focus(), to(this).tabIndex = 0) : kj(this.c, !0), a.b(), a.stopPropagation(), !0) : kp.m.Ga.call(this, a);
  };
  v.je = function() {
  ...
  mp.prototype.D = function(a) {
    var b = a.b.D(oa, { value: a.ea(), id: 'alt-input-text', type: 'text' }),
      c = a.b.D(oa, { value: np, id: 'alt-input-submit', 'class': '', type: Ma });
  ...
  v.D = function(a) {
    ...
    a.kb &= -256;
    a.sa(32, !1);
    return a.b.D(va, { 'class': Hi(this, a).join(' '), disabled: !a.isEnabled() }, a.ea() || '');
  };
  v.wd = function(a) {
    return a.tagName == va;
  };
  ...
  function xp(a) {
    a.nc && (wp(a) ? a.j().placeholder = a.nc : !a.j() || a.ec || a.Id || (M(a.j(), Xb), a.j().value = a.nc));
  }

  v.O = function() {
    pp.m.O.call(this);
    var a = this.j();
    P(a, { overflowY: qb, overflowX: Ha, boxSizing: La, MsBoxSizing: La, WebkitBoxSizing: La, MozBoxSizing: La });
    this.c = oh(a);
    this.o = ph(a);
  ...
  function yp(a) {
    ...
    b = a.j();
    isNaN(a.c.top) && (a.c = oh(b), a.o = ph(b));
    c = a.j().scrollHeight;
    var e = a.j();
    ...
    a.rf || (e = ph(e), d -= e.top + e.bottom);
    c += 0 < d ? d : 0;
    a.Sd ? c -= rp(a) : (a.sf || (d = a.c, c += d.top + d.bottom), a.rf || (a = ph(b), c += a.top + a.bottom));
    return c;
  }
  ...
  v.Hh = function() {
    wp(this) || (this.Id = !1, '' == this.j().value && (this.ec = !1, xp(this)));
  };
  v.zd = function(a) {
    if (!this.gc) {
      var b = this.j();
      !wp(this) && a && a.type == cb && (b.value == this.nc && this.nc && !this.Id && (Nf(b, Xb), b.value = ''), this.Id = !0, this.ec = '' != b.value);
      var c = !1;
      this.gc = !0;
      a = this.qb;
      if (b.scrollHeight) {
        var d = !1, e = !1, f = yp(this), h = b.offsetHeight, k = sp(this);
        var l = this.Fg;
        var m = this.j();
        l && m && this.Sd && (l -= rp(this));
        k && f < k ? (zp(this, k), d = !0) : l && f > l ? (zp(this, l), b.style.overflowY = '', e = !0) : h != f ? zp(this, f) : this.qb || (this.qb = f);
        d || e || !qp || (c = !0);
      } else {
        Ap(this);
      }
      this.gc = !1;
      c && (b = this.j(), this.gc || (this.gc =
        !0, (e = b.scrollHeight) ? (f = yp(this), c = sp(this), c && f <= c || (d = this.c, b.style.paddingBottom = d.bottom + 1 + 'px', yp(this) == f && (b.style.paddingBottom = d.bottom + e + 'px', b.scrollTop = 0, e = yp(this) - e, e >= c ? zp(this, e) : zp(this, c)), b.style.paddingBottom = d.bottom + 'px')) : Ap(this), this.gc = !1));
  ...
  function Dp(a, b) {
    ...
    a = b;
    for (e = 0; e < d.length; e++) a += d[e], a = Cp(a, '+-a^+6');
    a = Cp(a, '+-3^+b+-f');
    a ^= Number(c[1]) || 0;
  ...
  function Fp() {
    var a = Bp(String.fromCharCode(116)), b = Bp(String.fromCharCode(107));
    a = [a(), a()];
    a[1] = b();
    return a.join('');
  };
  ...
  Gp.prototype.b = function(a, b, c) {
    c = c.target;
    !c.Pc() || '[' != c.Lb()[0] && '{' != c.Lb()[0] ? (Jp(this, c), b && b(c.xa())) : (b = Kp(c, 'handleSingleResult_'), B(b) && (b = new cn(b)), a(b));
  };
  Gp.prototype.c = function(a, b, c) {
    ...
    if (c.Pc()) {
      ...
      Jp(this, c), b(null, c.ye());
    }
  };

  function Kp(a, b) {
    var c = a.Lb();
    a = { 'class': 'trans.common.TranslationAPI', func: b, url: a.ze() };
    try {
      var d = JSON.parse(c);
    } catch (e) {
      throw d = Vl.X(), a.js = c, a.error = e.message, d.log('jsonParseErr', a), e;
    }
    return d;
  }

  var Lp = {},
    Mp = (Lp[1] = 15, Lp[2] = 16, Lp[3] = 17, Lp[4] = 18, Lp[5] = 19, Lp[6] = 20, Lp[7] = 21, Lp[8] = 22, Lp[9] = 23, Lp);
  ...
  function Qp(a) {
    if (isNaN(a) || !isFinite(a)) return Rp;
    if (0 > a) return Sp(Qp(-a));
    for (var b = [], c = 1, d = 0; a >= c; d++) b[d] = a / c | 0, c *= 4294967296;
    return new Np(b, 0);
  }

  var Rp = Pp(0), Tp = Pp(1), Up = Pp(16777216);

  function Vp(a) {
    if (-1 == a.b) return -Vp(Sp(a));
  ...
  v.toString = function(a) {
    ...
    if (Xp(this)) return '0';
    if (-1 == this.b) return '-' + Sp(this).toString(a);
  ...
  v.add = function(a) {
    for (var b = Math.max(this.a.length, a.a.length), c = [], d = 0, e = 0; e <= b; e++) {
      var f = d + (Wp(this, e) & 65535) + (Wp(a, e) & 65535), h = (f >>> 16) + (Wp(this, e) >>> 16) + (Wp(a, e) >>> 16);
      d = h >>> 16;
      f &= 65535;
      h &= 65535;
      c[e] = h << 16 | f;
  ...
  function $p(a, b) {
    if (Xp(a) || Xp(b)) return Rp;
    if (-1 == a.b) return -1 == b.b ? $p(Sp(a), Sp(b)) : Sp($p(Sp(a), b));
    if (-1 == b.b) return Sp($p(a, Sp(b)));
    if (0 > aq(a, Up) && 0 > aq(b, Up)) return Qp(Vp(a) * Vp(b));
    for (var c = a.a.length + b.a.length, d = [], e = 0; e < 2 * c; e++) d[e] = 0;
    for (e = 0; e < a.a.length; e++) {
      for (var f = 0; f < b.a.length; f++) {
        var h = Wp(a, e) >>> 16, k = Wp(a, e) & 65535, l = Wp(b, f) >>> 16, m = Wp(b, f) & 65535;
        d[2 * e + 2 * f] += k * m;
        bq(d, 2 * e + 2 * f);
        d[2 * e + 2 * f + 1] += h * m;
        bq(d, 2 * e + 2 * f + 1);
  ...
  function Yp(a, b) {
    if (Xp(b)) throw Error('division by zero');
    if (Xp(a)) return new cq(Rp, Rp);
    if (-1 == a.b) return b = Yp(Sp(a), b), new cq(Sp(b.a), Sp(b.b));
    if (-1 == b.b) return b = Yp(a, Sp(b)), new cq(Sp(b.a), b.b);
    if (30 < a.a.length) {
      if (-1 == a.b || -1 == b.b) throw Error('slowDivide_ only works with positive integers.');
      for (var c = Tp, d = b; 0 >= aq(d, a);) c = dq(c, 1), d = dq(d, 1);
      var e = eq(c, 1), f = eq(d, 1);
      d = eq(d, 2);
      for (c = eq(c, 2); !Xp(d);) {
        var h = f.add(d);
        0 >= aq(h, a) && (e = e.add(c), f = h);
        d = eq(d, 1);
        c = eq(c, 1);
      }
      b = Zp(a, $p(e, b));
    ...
    for (e =
      ...
      f = Qp(c);
      for (h = $p(f, b); -1 == h.b || 0 < aq(h, a);) c -= d, f = Qp(c), h = $p(f, b);
      Xp(f) && (f = Tp);
      e = e.add(f);
      a = Zp(a, h);
    }
  ...
  v.and = function(a) {
    for (var b = Math.max(this.a.length, a.a.length), c = [], d = 0; d < b; d++) c[d] = Wp(this, d) & Wp(a, d);
  ...
  function dq(a, b) {
    var c = b >> 5;
    b %= 32;
    for (var d = a.a.length + c + (0 < b ? 1 : 0), e = [], f = 0; f < d; f++) e[f] = 0 < b ? Wp(a, f - c) << b | Wp(a, f - c - 1) >>> 32 - b : Wp(a, f - c);
    return new Np(e, a.b);
  }
  ...
  function eq(a, b) {
    var c = b >> 5;
    b %= 32;
    for (var d = a.a.length - c, e = [], f = 0; f < d; f++) e[f] = 0 < b ? Wp(a, f + c) >>> b | Wp(a, f + c + 1) << 32 - b : Wp(a, f + c);
    return new Np(e, a.b);
  };Zp(dq(Tp, 32), Tp);
  Zp(dq(Tp, 128), Tp);
  var fq = I || K || Te || Ue || !1;
  ...
  function gq(a, b, c, d, e, f, h, k, l) {
    ...
    l && this.f.ka(!1);
    if (0 < this.J) for (a = this.f, a.o = !0, b = 0; b < a.f; b++) h = kg(g, 'goog-menu', ''), e = kg(g, null, h), h = new Ym(e, h), a.g[b] = h, document.body.appendChild(e);
    this.f.fa(c);
    this.h = k || null;
    this.Ia = null != d ? d : -1;
    this.L = Vl.X();
  ...
  function lq(a, b) {
    null != a.o && a.o.f();
    b && (a.l = new cn(b), a.P = null);
    mq(a) && (a.g.b(), null != a.h && a.h.a(!1));
    if (a.l) {
      b = 0 != ag().length;
      a.b.Qc(a.j());
      a.f.gd();
      a.ua && (a.ua.b = a.l);
      for (var c = '', d = 0, e = 0; e < Y(a.l, 5); e++) nq(a.l, e) && (c += ' '), c += oq(a.l, e), d += Y(dn(a.l, e), 2);
      if (0 != d) {
        c = [];
        d = !1;
        e = a.l;
        ...
        for (e = 0; e < Y(a.l, 5); e++) {
          f = dn(a.l, e);
          h = bn(f, 0);
          nq(a.l, e) ? a.b.appendChild(a.j(), a.b.a.createTextNode(' ')) : ('km' ==
            a.c || 'lo' == a.c) && a.b.appendChild(a.j(), K ? og() : Te ? document.createTextNode('&shy;') : I ? document.createTextNode('&#8203;') : og());
          null != f.Ea[4] && 0 < wm(f, 4).length && 0 == vm(f, 5) && c.push(wm(f, 4));
          var l;
          k = oq(a.l, e);
          /^[\s\xa0]*$/.test(k) ? 0 == k.length || (l = pq(k)) : (l = a.b.D(ua, null, k), h = vm(h, 1), 0 <= a.Ia && h < a.Ia && M(l, 'alt-low-conf'), Dj(a.C, a.a + '.' + a.c + '.' + wm(f, 0)) && (h = a.C.get(a.a + '.' + a.c + '.' + wm(f, 0)), h != qq(f, 0) && (a.b.ib(l, h), M(l, Fa), d = !0, rq(a, !0))), l.title = cp, dp(a.f, l, f));
        ...
        if (null != a.g) {
          ...
          Dj(a.C, l) && (sq(a, !1), d = !0, tq(a, a.C.get(l)), null != a.h && a.h.a(!1), rq(a, !0));
        }
        d || (rq(a, !1), sq(a, !1));
    ...
    for (a = 0; a < Y(b, 5); a++) {
      ...
      if ((e = e && e) && pm(c.Ea, e.Ea)) {
        ...
        if (null != d && d) {
          ...
          e = b + 1;
          f = b;
          for (b = oq(d, b).length; 64 > b && (e != a || f != c);) e < a && (b += oq(d, e++).length + 1), 64 > b && f > c && (b += oq(d, --f).length + 1);
          b = wq(d, f, e);
        } else {
          b = '';
        }
  ...
  function wq(a, b, c) {
    var d = [];
    d.push(oq(a, b));
    for (b += 1; b < c; b++) nq(a, b) && d.push(' '), d.push(oq(a, b));
    return d.join('');
  }

  function nq(a, b) {
    if (0 == b) return !1;
    var c = dn(a, b), d = dn(a, b - 1);
    if (c = um(bn(c, 0), 2) && !um(bn(d, 0), 3)) a = oq(a, b - 1), b = a.length - 1, c = !(0 <= b && a.indexOf('\n', b) == b);
    return c;
  }
  ...
  v.O = function() {
    ...
    null != this.h && null != this.h.b && (U(this).w(this.h.b, Sa, this.wi), ki(U(this), this.h.b, this.va.a, this.va));
  ...
  v.si = function(a) {
    if (a.type != rb || a.target == this.f) {
      if (null == a.target && null != this.g) {
        this.L.log('editpopupclk'), Am(this.va, 233), null != this.h && this.h.a(!0), this.g.l(uq(this)), this.qa = this.o.j().style.display != q, this.o.reset(), null != this.h ? this.o.ka(this.h.b.style.display != q) : this.o.ka(!1), rq(this, !1);
      } else {
        var b = a.g;
        ...
        if (null != b && null != a.target) {
          ...
          this.b.ib(d, c);
          c == qq(e, 0) ? (Nf(d, Fa), 0 == ag().length && (rq(this,
            !1), sq(this, !1))) : (M(d, Fa), rq(this, !0), sq(this, !0));
          ...
          for (var h in d) typeof d[h] === Ub && 64 < d[h].length && (d.tr = 1, d[h] = d[h].substr(0, 64));
  ...
  function tq(a, b) {
    if (a.j()) {
      ...
      a.W = b;
      var c;
      if (c = a.j().childNodes && 0 < a.j().childNodes.length) c = (c = a.j().childNodes[0]) ? Dj(a.f.a, xc(c)) : !1;
      c ? (a.b.Qc(a.j()), a.f.gd(), b = a.b.D(ua, Fa, a.W), a.b.appendChild(a.j(), b), dp(a.f, b, new an)) : a.j().innerHTML = He(b).replace(/(\r\n|\r|\n)/g, '<br>');
    }
  }
  ...
  v.bi = function() {
    mq(this) && (this.g.c() && (tq(this, this.g.a()), this.qa = !0), this.g.b(), null != this.h && this.h.a(!1), this.g.c() && rq(this, !0), this.o.ka(!0), Q(this.o.j(), this.qa), this.dispatchEvent(Ca));
    Am(this.va, 215);
  ...
  v.ri = function() {
    ...
    if (a) {
      if (0 < this.J) {
        ...
        if (1 == this.J) {
          for (var c = [], d = 0, e = Y(a, 2); d < e; d++) c.push(qq(a, d));
          d = this.Za;
          var f = this.c, h = this.a, k = yq(this), l = C(this.mj, this);
          e = new Nj;
          var m = new Nj;
          e.set('client', 'mt');
          e.set('sl', f);
      ...
      this.a && this.c && this.ca && (b.segments = Y(this.l, 5), b.sl = this.a, b.tl = this.c, b.hl = this.ca);
      Am(this.va, 238);
  ...
  v.nj = function(a, b) {
    if (1 == this.J || 1 < Y(b, 5)) {
      ...
      var d = 1;
      for (var e = Y(b, 0); d < e; d++) c += ' ' + wm(new ym(xm(b, 0, d)), 0);
      d = c;
    } else if (1 == Y(b, 5)) {
      c = [];
      b = dn(b, 0);
      d = 0;
      for (e = Math.min(this.J, Y(b, 2)); d < e; d++) c.push(qq(b, d));
      d = c.join(', ');
    } else {
      d = '...';
    }
  ...
  v.mj = function(a) {
    for (var b = 0; b < a.length; b++) hp(this.f, b, a[b]);
  };

  function xq(a) {
    mq(a) && (null != a.h && a.h.a(!1), a.g.b());
    Fj(a.C);
    a.W = null;
    lq(a);
    a.dispatchEvent(Ca);
      ...
      if (null != h) {
        ...
        if (0 != m.length) {
          if (0 == a.length || m != a[a.length - 1]) {
            a.push(m), d = zq(this, a.length - 1), e = 0, d = {
              source: m,
              original_target: n,
              segment_source: d,
              phrase_correction: [],
          ...
          if (0 != l) {
            for (m = qq(h, 0).length,
              ...
              n = new $m(xm(h, 3, m)), l.source_span.push({
                start: vm(n, 0),
                end: vm(n, 1),
              });
            }
  ...
  var Bq = window.google && window.google.translate && window.google.translate.v || '', Cq = Aq._cl || 'en',
    Dq = Aq._cuc, Eq = Aq._cnad, Fq = Aq._cest, Gq = Aq._cnal || {}, Hq = 'lib' == Aq._cam ? 1 : 0,
    Iq = (Aq._cac || 'te') + (1 == Hq ? '_lib' : ''), Jq = function() {
      function a(d) {
        return function() {
          return d;
        };
    ...
    }(), Kq = Aq._pah || '', Lq = Aq._pas || 'https://', Mq = Aq._pbi || '', Nq = Aq._pci || '', Oq = Aq._plla || '',
    Pq = Aq._pli || '', Qq = Aq._ps || '', Rq = Aq._puh ||
    '', Sq = '//' + Rq + fa + Iq,
  ...
  function cr(a) {
    ...
    for (c in a) {
      if (a[c] !== Object.prototype[c]) {
        var d = Fe(c);
        if (A(a[c]) == Ga) for (var e = 0; e < a[c].length; ++e) b.push(d + '=' + Fe(a[c][e])); else b.push(d + '=' + Fe(a[c]));
      }
    }
    return b.join('&');
  }
  ...
  (function() {
    ...
    var b = null, c = null;
    kr = function(d, e, f) {
      for (var h in f) f[h] !== Object.prototype[h] && (e[h] = vc(f[h]) ? f[h] : Cc(a, d, Number(f[h])));
    };
    lr = function() {
      b && mr();
      b = [];
...
*/
  ...
  qr.prototype.cancel = function(a) {
    if (this.a) {
      ...
      this.a || (a = new sr(this), tr(this), ur(this, !1, a));
    }
  };
  ...
  function vr(a) {
    if (a.h && a.a && yr(a)) {
      var b = a.h, c = zr[b];
      c && (x.clearTimeout(c.ia), delete zr[b]);
      a.h = 0;
    }
    ...
    for (var d = c = !1; a.g.length && !a.l;) {
      ...
      if (f = a.f ? h : f) {
        try {
          ...
          if (Zk(b) || typeof x.Promise === p && b instanceof x.Promise) d = !0, a.l = !0;
        } catch (l) {
          b = l, a.f = !0, yr(a) || (c = !0);
        }
      }
    ...
    a.c = b;
    d && (k = C(a.B, a, !0), d = C(a.B, a, !1), b instanceof qr ? (xr(b, k, d), b.K = !0) : b.then(k, d));
    c && (b = new Ar(b),
      zr[b.ia] = b, a.h = b.ia);
  }
  ...
  function Br(a, b) {
    ...
    var d = rd(a).toString(), e = document.createElement(ta), f = { Vg: e, Eb: void 0 }, h = new qr(f), k = null,
    ...
    e.onload = e.onreadystatechange = function() {
      e.readyState && 'loaded' != e.readyState && e.readyState != Ua || (Cr(e, c.Jh || !1, k), tr(h), ur(h, !0, null));
    };
    e.onerror = function() {
      Cr(e, !0, k);
      var m = new Dr(0, 'Error while loading script ' +
        d);
      tr(h);
      ur(h, !1, m);
    };
    f = c.attributes || {};
    fd(f, { type: 'text/javascript', charset: 'UTF-8' });
    dg(e, f);
    Ae(e, a);
    Er(b).appendChild(e);
    return h;
  ...
  Fr.prototype.cancel = function(a) {
    a && (a.Tf && a.Tf.cancel(), a.ia && Jr(a.ia, !1));
  };
  ...
  function Mr(a, b) {
    ...
    !this.b && window.XDomainRequest && 'file:' != window.location.protocol && (this.b = 2, this.a.a.set('u', window.location.href));
  }

  G(Mr, Kr);
  kr(17170, Mr.prototype, { Eg: 1, Dg: 2 });
  Mr.prototype.c = function() {
    return !!this.b;
  };
  Mr.prototype.send = function(a, b) {
    var c = gr(), d = ++this.g, e = {}, f = {};
    'q' in a && (f.q = a.q, delete a.q);
    a.mode = this.b;
    1 == this.b ? (e.sb = new Jl, S(e.sb, Ua, C(function() {
      e.uc || (e.sb.Pc() ? b(e.sb.Lb()) : (this.Dg(), b(null, e.sb.Lb() || null)), Nr(this, d));
    }, this)), S(e.sb, 'timeout', C(function() {
      e.uc || (this.Eg(), Nr(this, d));
    }, this)), e.sb.send(this.a.toString() + '&' + cr(a), sa, cr(f), { 'Content-Type': 'application/x-www-form-urlencoded' })) : (e.Xa = new XDomainRequest, e.Xa.timeout = 2E4, e.Xa.onload = C(function() {
      e.uc || (b(e.Xa.responseText),
        Nr(this, d));
    }, this), e.Xa.onerror = C(function() {
      e.uc || (this.Dg(), b(null), Nr(this, d));
    }, this), e.Xa.ontimeout = C(function() {
      e.uc || (this.Eg(), b(null), Nr(this, d));
    }, this), e.Xa.open(sa, this.a.toString() + '&' + cr(a)), e.Xa.send(cr(f)));
    this.f[d] = e;
    hr(c);
    return d;
  };
  Mr.prototype.cancel = function(a) {
    var b = this.f[a];
    b && (b.uc = !0, b.Xa && b.Xa.abort(), Nr(this, a));
  };
  ...
  function Qr(a, b) {
    ...
    if (A(b) != Ga) {
      ...
      a = [];
      for (var c = 0; c < b.length; ++c) A(b[c]) != Ga ? a[c] = [b[c], 200] : a[c] = [b[c][0], 200, b[c][1]];
    }
    return a;
  }
  ...
  Ur.prototype.b = function() {
    if (null != this.a && Sr(this.a)) return el(this.a);
    this.a = null;
  ...
  function Vr(a, b, c, d, e, f) {
    R.call(this);
    var h;
    b ? h = { client: b } : h = { anno: 3, client: Iq, format: 'html', v: '1.0' };
    c && (h.sp = c);
    h.key = a;
    Bq && (h.logld = 'v' + Bq);
    this.s = d || null;
    this.Vb = e || null;
    this.a = null;
    this.b = { vc: C(this.G, this), Gg: 300 };
    this.h = h;
    a = this.f = new Pr(h, f);
    b = Lq + Oq;
    this.g = a.a ? new Or(b, a.a, { client: Iq }) : new Lr(b, { client: Iq }, 'cb');
    a = this.f;
    if (a.a) {
      if (!a.a) throw Error('this.remoteApiProxyHandlers_ is null');
      a = [{ na: new Or(Lq + Kq + ea, a.a, a.b), vc: C(a.f, a), Rd: 1900, bf: 4294967295, af: -1, tf: 0, hd: !1 }];
    } else {
      b = Lq + Kq, a = [{
        na: new Mr(b +
          ea, a.b), vc: C(a.g, a), Rd: 30720, bf: 4294967295, af: -1, tf: 0, hd: !1,
      }, {
  ...
  Vr.prototype.translate = function(a, b, c, d, e, f, h, k) {
    var l = this, m = this.a.vc(a), n = { q: b, sl: c, tl: d };
  ...
  var $r = Uq(['A', 'ABBR', 'ACRONYM', 'B', 'BASEFONT', 'BDO', 'BIG', 'CITE', 'DFN', 'EM', 'FONT', 'I', oa, 'NOBR', 'LABEL', 'Q', 'S', 'SMALL', ua, 'STRIKE', 'STRONG', 'SUB', 'SUP', va, 'TT', 'U', 'VAR']),
    ...
    bs = Uq(['BR', 'CODE', 'IMG', 'KBD', 'MAP', 'OBJECT', 'PARAM', ta, 'STYLE', 'WBR', 'svg']), cs = Uq(['submit', Ma]);

  function ds(a, b) {
    this.a = new kn(a, !1, b, 3 == a.nodeType ? 0 : 1, 1);
    this.c = I ? [] : null;
    for (this.b = []; a = a.parentNode;) es(this, a, !0);
    this.b.push(!1);
    this.b.reverse();
  ...
  ds.prototype.next = function() {
    try {
      this.c && 0 < this.c.length && -1 == this.a.c && this.c.length--, -1 == this.a.c && this.b.length--, this.c && 0 < this.c.length && 1 != this.a.c && !this.a.node.nextSibling ? ln(this.a, this.c[this.c.length - 1], -1, this.a.depth - 1) : (this.a.next(), this.c && 1 == this.a.c && this.c.push(this.a.node)), 1 == this.a.c && this.a.o && es(this, this.a.node);
    } catch (a) {
      a != xj && this.Pi(a), this.f = !0;
    }
  };
  ...
  os.prototype.M = function() {
    this.ub || (os.m.M.call(this), delete this.Qd);
  };
  ...
  v.send = function(a, b, c, d) {
    ...
    this.rb = a = new Kj(a);
    b = b ? b.toUpperCase() : 'GET';
    c && (c = Math.floor(2147483648 * Math.random()).toString(36) + Math.abs(Math.floor(2147483648 * Math.random()) ^ D()).toString(36), a.a.set('zx', c));
    ss || (ss = kg('FORM'), ss.acceptCharset = 'utf-8', c = ss.style, c.position = Ba, c.visibility = qb, c.top = c.left = '-10px', c.width = c.height = '10px', c.overflow = qb, document.body.appendChild(ss));
    this.Y = ss;
    'GET' == b && ts(this.Y, a.a);
    d && ts(this.Y, d);
    d = this.Y;
  ...
  v.abort = function(a) {
    this.ma && (di(xs(this)), this.Zd = this.ma = this.wc = !1, this.Ha = a || 7, this.dispatchEvent('abort'), ys(this));
  };
  v.F = function() {
    this.ma && this.abort();
    ps.m.F.call(this);
  ...
  function us(a) {
    ...
    a.ja = Xf(a.Y).D(na, { name: a.Pb, id: a.Pb });
    I && 7 > Number(kf) && ye(a.ja, new Fd(Gd, ld(new id(jd, 'javascript:""'))));
    var b = a.ja.style;
    b.visibility = qb;
    b.width = b.height = '10px';
    b.display = q;
    K ? b.marginTop = b.marginLeft = '-10px' : (b.position = Ba, b.top = b.left = '-10px');
    if (I && !L('11')) {
      a.Y.target = a.Pb || '';
      ...
      if (document.baseURI) {
        ...
        d = He(b), d = se('<body><iframe id="' + d + '" name="' + d + '"></iframe>', null);
      }
      ...
      var k = $f('SELECT', e);
      d = 0;
      for (f = h.length; d < f; d++) for (var l = $f(qa, h[d]), m = $f(qa, k[d]), n = 0, r = l.length; n < r; n++) m[n].selected = l[n].selected;
      h = $f(oa, a.Y);
      k = $f(oa, e);
      d = 0;
      ...
      try {
        a.a = !1, e.submit(), c.close(), J && sl(a.gh, 250, a);
      } catch (w) {
        bi(c.getElementById(b), zb, a.Td, !1, a), c.close(), As(a, 2);
      }
    }
  }
  ...
  function Bs(a, b) {
    ...
    d ? As(a, d) : (a.Zd = !0, a.Ha = 0, a.dispatchEvent(Ua), a.dispatchEvent('success'), ys(a));
  }

  function As(a, b) {
    a.a || (a.Zd = !1, a.ma = !1, a.wc = !0, a.Ha = b, a.dispatchEvent(Ua), a.dispatchEvent('error'), ys(a), a.a = !0);
  }
  ...
  v.Vf = function() {
    this.Ob && (tl(this.Ob), this.Ob = null);
    for (; 0 != this.b.length;) {
      var a = this.b.pop();
      ug(a);
    }
  ...
  v.gh = function() {
    if (this.ma) {
      ...
      a && !Re(a, 'documentUri') ? (bi(xs(this), zb, this.Td, !1, this), navigator.onLine ? As(this, 3) : As(this, 9)) : sl(this.gh, 250, this);
    }
  };
  ...
  v = Cs.prototype;
  v.D = function() {
    var a = { Eh: this.l, method: this.o, Qh: this.h, dir: nd.test(Cq) ? Qb : 'ltr' };
    this.S(kk(ks, a));
  };
  v.S = function(a) {
    this.A = a;
  ...
  v.rj = function() {
    var a = !0;
    this.g && (a = this.g());
    a && (a = new ps, S(a, 'success', function() {
  ...
  v.Ub = function() {
    ...
    if (a && b) {
      ...
      c = this.c.oa();
      if (this.g.Ua() && b && c) {
        var d = this.c.Mc(), e = C(this.$i, this);
        this.g && this.g.translate(e, { dj: [d], zk: !0, Dk: !1 }.dj, b, c, 0, !1);
        Ds(this.a, { gtrans: a, text: this.c.Mc(), hl: Cq, langpair: b + '|' + c });
        Ds(this.a, this.o);
        Ds(this.a, { client: kq });
      }
  ...
  v.Ub = function() {
    Hs.m.Ub.call(this);
    this.f.Nb(this.c.J);
    var a = this.c.cb(), b = this.c.oa();
    a && b && (Ds(this.a, { gtrans: this.c.J, text: this.c.Mc(), hl: Cq, langpair: a + '|' + b }), Ds(this.a, this.g));
    this.dispatchEvent(Ob);
    this.f.j().focus();
  };
  v.Bb = function() {
  ...
  function Js(a, b, c) {
    if (b = a.h.c[b]) {
      ...
      for (var d = 0; d < b.Ba.length; ++d) b.Ba[d] && a.zg(b.Ba[d], c);
    }
  }
  ...
  v.vf = function(a) {
    this.progress = a;
    1 == this.a && (this.b = D() - this.duration * this.progress, this.endTime = this.b + this.duration);
  };
  v.F = function() {
  ...
  function Os(a, b) {
    ...
    Qs(a, a.progress);
    1 == a.progress ? (a.a = 0, Ls(a), a.Qa($a), a.f()) : 1 == a.a && a.ff();
  }
  ...
  v.Ci = function(a, b) {
    this.isVisible() && (this.a = new Vs(this.j(), a), U(this).Ab(this.a, $a, C(function() {
      b && b();
    }, this)), this.a.play());
  };
  v.I = function(a) {
  ...
  v.fa = function() {
    ...
    this.j() && this.K && this.Ya && this.g.j() && this.H && this.o && (this.l.w(window, 'resize', C(this.ob, this)), this.l.w(this, rb, C(this.bj, this)), this.Za.length && (this.ge.apply(this, this.Za), this.Za = []));
  };
  v.ge = function(a) {
    for (var b = [], c = 0; c < arguments.length; ++c) {
      ...
      if (d) {
        if (this.K || d.Qd) {
          var e = d;
          var f = kg(ua, { 'class': e.className || 'activity-link' });
          Gg(f, e.Ye || '');
          e = f;
          b.push(e);
          qg(d.Qd || this.K, e);
          d.lc && d.Bb && (f = C(this.Wh, this, d), this.l.w(e, Sa, f), d.Pd && this.l.w(this.H, d.Pd, f));
          d.id = d.id || si(d);
  ...
  v.Rg = function(a) {
    for (var b = 0; b < arguments.length; ++b) {
      var c = typeof arguments[b] === Ub || arguments[b] instanceof String ? arguments[b] : arguments[b].id,
        d = this.P[c], e = this.jb[c];
      d && e && (this.f && this.f.id === c && this.oe(), this.l.ba(d, [Vb, Na]), d.M(), this.W[c] && delete this.W[c], delete this.P[c], delete this.jb[c], ug(e));
    }
  };
  v.Wh = function(a) {
    if (this.H) {
      a != this.f && this.f && ($s(this.g), this.f.Bb.call(this.f), this.f.j() && (this.f.j().style.display = q), bt(this, !1), this.f = null);
      bt(this, !0);
      $s(this.g);
      this.f = a;
      if (this.W[a.id]) {
        ...
        a.fa(), b = a.j(), c = a.lc, this.l.w(a, [Vb, Na], C(this.oe, this)), a.cd && (this.W[a.id] = b);
      }
      qg(this.H, b);
      c.call(a, this);
      a = new Ws(b, 100);
  ...
  v.oe = function() {
    if (this.f) {
      if ($s(this.g), this.f.Bb.call(this.f), this.f.j()) {
        var a = new Vs(this.f.j(), 100);
        this.l.Ab(a, $a, C(function() {
          ug(this.f.j());
          this.f = null;
          bt(this, !1);
          Mg(this.g.j()) && (Ys(this.g), this.ob(!0, !0));
        }, this));
        a.play();
      } else {
        bt(this, !1), this.f = null;
      }
    }
  };
  v.cf = function(a, b) {
  ...
  v.Je = function(a) {
    if (!this.C) {
      ...
      this.za = b;
      this.Yb();
      b != this.b ? (this.b = b, Zo(this, b), $o(this), Xo(this, a)) : Zo(this, b);
    }
  };
  v.bj = function() {
    $s(this.g);
  ...
  function bt(a, b) {
    ...
    if (a.C) {
      ...
      a.ra && (null != (a.s || null) && ((a.s || null).a = a.ra), Xg(a.j(), a.ra), a.ra = null);
    }
  ...
  v.Sc = function(a) {
    this.isVisible() ? (this.sc = a, (this.sc ? this.h.w : this.h.ba).call(this.h, O(this.j()), Ab, this.gf, !0)) : at.m.Sc.call(this, a);
  };
  v.bc = function(a) {
    at.m.bc.call(this, a);
    if (a) {
  ...
  v.ob = function(a, b) {
    ...
    if (this.s) {
      ...
      b && (b = this.$e || {}, a -= b.top || 10, d -= b.left || 10);
      a -= c;
      (this.s || null).a.y = a;
      (this.s || null).a.x = d;
      Xg(this.j(), new N(d, a));
  ...
  var ct = {
    set: function(a, b) {
      ...
      var c = ct.get(a), d = Vc(arguments, 1), e = c.length + d.length;
      ct.Nf(c, d);
      ct.set(a, c.join(' '));
      return c.length == e;
    }, remove: function(a, b) {
      var c = ct.get(a), d = Vc(arguments, 1), e = ct.ag(c, d);
      ct.set(a, e.join(' '));
      ...
      c) {
      for (var d = ct.get(a), e = !1, f = 0; f < d.length; f++) d[f] == b && (Uc(d, f--, 1), e = !0);
      e && (d.push(c), ct.set(a, d.join(' ')));
      return e;
    }, xk: function(a, b, c) {
      var d = ct.get(a);
...
*/
  ...
  ft.prototype.start = function() {
    if (!this.g) {
      ...
      var a = [], b;
      var c = 62;
      for (b = 0; 15 > b; b++) a[b] = et[0 | Math.random() * c];
      this.o = a.join('');
      this.s = 0;
      this.c = this.a = this.f = this.b = -1;
      this.B = D();
  ...
  ft.prototype.stop = function() {
    this.g && (this.g = !1, gt(this));
  };
  ft.prototype.l = function() {
    this.g && (gt(this), sl(this.l, 1E3, this));
  };
  ...
  function jt(a, b) {
    ...
    b && (this.f.g = b || {});
    a = this.f;
    a.b = new at({ pj: a.a.pj });
    a.b.yg = 300;
    a.b.Zg = 1E3;
    a.b.Sc(!0);
    a.c.w(a.b, 'show', C(a.Aj, a));
    a.c.w(a.b, rb, C(a.zj, a));
    b = new Gs({ $a: a.a.$a, id: 'alternate', Ye: Z.mh, cd: !0 }, a.g);
    a.b.ge(b);
    a.c.w(b, Vb, C(a.Mg, a));
    a.a.Kb && (b = new Hs({
      id: 'contribute',
      Pd: Xa, cd: !0,
    }, a.g), a.b.ge(b), a.c.w(b, Vb, C(a.Mg, a)));
    a.b.fa();
    this.g = this.b = null;
    this.a.trackVisibility && null != x.IntersectionObserver && (this.b = new ht, this.g = new ft(this.b));
  }

  G(jt, R);

  function kt(a, b, c, d, e, f) {
    d = a.c[++a.h] = { id: a.h.toString(), Ph: f, text: c, Ek: e || c, T: d, qj: a.s, Bj: a.o, Ba: b };
    for (e = 0; e < b.length; ++e) b[e] && a.f.eh(d.id, b[e]);
    if (a.b) {
      for (e = a.b, f = c.length, e.c += f, c = e.a.length, e.a.push(f), f = 0; f < b.length; ++f) {
        var h = e, k = b[f];
        yg(k) ? (k[it] = c, h.f += Mg(k).length, h.b && h.b.observe(k)) : h.Cg(k.nodeType);
      }
    }
    a.g && a.g.start();
    return d.id;
      ...
      if (e) {
        if (c.b) {
          for (var f = c.b, h = e.Ba, k = 0; k < h.length; ++k) {
            var l = f, m = h[k];
            yg(m) ? (m[it] = void 0, l.b && l.b.unobserve(m)) : l.Cg(m.nodeType);
          }
        }
  ...
  function nt(a) {
    ...
    do {
      ...
      l == a[h].node || !k && 1 == m && (null != l && null == l.previousSibling ? 0 : !ot(pt(l))) ? (m = qt(l), d.push({
        node: m,
        Pa: fc(),
      }), e[d.length - 1] = n, sg(m, l), l == a[h].node && (c[h++] = d.length - 1, k = !0)) : k = !1;
    } while (l != f);
    return { Ef: e, cj: c, Ei: d };
  }
  ...
  function pt(a) {
    ...
    for (a = a.previousSibling; null != a && null != a && 3 == a.nodeType && "" == ud(Mg(a));) a = a.previousSibling;
    return a;
  }
  ...
  function rt(a, b, c, d, e, f) {
    ni.call(this);
    this.a = [];
    for (var h = 0; h < a.length; ++h) this.a.push('nodeType' in a[h] ? st(a[h]) : a[h]), tt(a[h].node);
    this.f = b;
    this.G = d || 0;
    this.J = e || 0;
    this.l = c;
  ...
  var vt = '_gt_' + Math.random().toString(36).substr(2), wt = '_gtn_' + Math.random().toString(36).substr(2);

  function xt(a) {
    if (!a) return !1;
    if (3 != a.nodeType || !I) return vt in a && !!a[vt];
    if (!a.parentNode) return !0;
    if (!(wt in a.parentNode)) return !1;
  ...
  (function() {
    ...
    var b = {};
    st = function(c, d) {
      if (c.tagName == wa) return { node: c, Pa: a, de: !0, Ag: !0, Cf: !0 };
      if (3 == c.nodeType) {
        return {
    ...
    if (!a.g && a.K && !a.B && !a.C) {
      ...
      if (b = Ct(a.a)) {
        ...
        if (1 == b.length && b[0] && b[0].Cf) {
          for (var d = [], e = 0; e < c.length; ++e) for (var f = 0; f < c[e].$.length; ++f) d.push(c[e].$[f].T);
      ...
      if (b && (b = nt(a.a))) {
            ...
            for (var l = 0; l < f.length; ++l) {
              if (!(h[l] > h[e[k]])) {
                if (h[l] == h[e[k]]) {
                  ...
                  for (var m =
                    h[e[k]] - h[l], n = f[e[k]].node.parentNode; m-- && n && n != f[l].node.parentNode;) {
                    n = n.parentNode;
                  }
        ...
        for (h = e.length - 1; 0 <= h; --h) {
          for (k = e[h], l = k.$.length - 1; 0 <= l; --l) {
            if (m = k.$[l], !(0 > m.R) && d[m.R] && d[m.R].node) {
              if (0 > f) {
                m.Kd = Uq(c[m.R]), f = c[m.R][c[m.R].length - 1];
              } else {
        ...
        for (c = e = 0; c < a.b.length; ++c) {
          ...
          for (n = 0; n < h.$.length; ++n) {
            ...
            m += r.T;
            if (0 > r.R) {
              var w = -1, F = -1, E = l[h.$[n - 1].R];
              void 0 !== E && (w = k[E]);
              n < h.$.length - 1 && (E = l[h.$[n + 1].R], void 0 !== E && (F = k[E]));
              if (0 <= w || 0 <= F) {
                a:if (F = (0 > w || F < w) && n < h.$.length - 1, w = h.$[F ? n + 1 : n - 1], !(w.R >= f.length || null == f[w.R].node)) {
                  E = r.T;
                  r.T = '';
                  if (/^ +$/.test(E) && (r = F ? w.T.charCodeAt(0) : w.T.charCodeAt(w.T.length - 1), 3584 <= r && 3711 >= r || 12288 <= r && 12351 >= r || 12352 <= r && 12543 >= r || 12784 <= r && 12799 >= r || 19968 <= r && 40959 >= r || 65280 <= r && 65519 >= r)) break a;
                  w.T = F ? E + w.T : w.T + E;
                }
              }
            }
          ...
          r = [];
          for (w =
            0; w < k.$.length && !(e >= l.length); ++w) {
            if (F = k.$[w], F.Kd && !(0 > F.R) && h[F.R].node && F.T) {
              if (e == n[F.R] || e in F.Kd && (!(e + 1 in F.Kd) || e + 1 != n[F.R])) {
                if (l[e] && l[e].node) {
                  E = qt(l[e].node);
                  r.push(E);
                  for (var ca = l[e].node, $l = m[n[F.R]] - m[e], hf = E, tb = h[F.R].node.parentNode, Mi = hf; tb && $l--;) Mi = tb.cloneNode(!1), Mi.appendChild(hf), tb = tb.parentNode, hf = Mi;
                  ca.appendChild(Mi);
                  ca = h[F.R].node;
                  h[F.R].de ? h[F.R].Ag || E.appendChild(ca) : (ca = h[F.R].node.cloneNode(!1), ca.id && (ca.id = ''), E.appendChild(ca));
                  h[F.R].Pa(F.T, ca);
                }
              } else {
                ++e, --w;
          ...
          if (d.Ng) {
            ...
            l = r.length;
            m = -1;
            for (n = 0; n < d.$.length; ++n) w = d.$[n].R, 0 <= w && r[w] && r[w].node && (m = Math.max(m, w), l = Math.min(l, w));
            r = '';
            for (n = l; n <= m; ++n) k[n] && (r += k[n]);
            k = r;
          }
          if (a.s) 3 != a.s.a.Kb && a.L.push(kt(a.s, h, k, f, d.kf, a)); else for (d = 0; d < h.length; ++d) h[d].title = k;
        }
        b = a.a;
        for (c = 0; c < b.length; ++c) b[c].node && !b[c].de && ug(b[c].node);
        b = a.a;
        c = a.c;
        a = a.h;
        for (e = d = 0; e < c.length; ++e) {
          if (f = c[e].node) {
            ...
            (d >= b.length || e != a[d]) && !f.firstChild && (ug(f), c[e].node = null);
          }
        }
      }
    }
  ...
  rt.prototype.restore = function() {
    if (this.B) {
      if (this.B = !1, this.s && lt(this.s), this.L = [], Ct(this.c), 1 == this.a.length && this.a[0].Cf) {
        ...
        for (var a = 0, b = 0; b < this.c.length; ++b) {
          ...
          if (c) {
            for (; a < this.a.length && b > this.h[a];) {
              var d = a++;
              this.a[d].node && (Dt(this.a[d].node), this.a[d].node = null);
            }
            if (a < this.a.length && b == this.h[a] && this.a[a].node) {
              this.a[a].Ag || (rg(c), c.appendChild(this.a[a].node));
  ...
  rt.prototype.F = function() {
    rt.m.F.call(this);
    this.restore();
    for (var a = 0; a < this.a.length; ++a) this.a[a].node && Dt(this.a[a].node);
    this.a = null;
  };
  ...
  function Et(a) {
    for (var b, c = a.firstChild; c; c = b) b = c.nextSibling, 3 != c.nodeType && (c == a.firstChild ? sg(c, a) : tg(c, a), Et(c));
  };
  ...
  function Ht(a, b, c, d) {
    a.f.c || (b = {
      ...
      size: 0,
      continuous: !0,
    }, a.zc = null, Jm(a.f, a.b), Km(a.f, d), Lm(a.f, C(function(e) {
      this.Oi(e);
      d();
    }, a)), Mm(a.f, b));
  }
  ...
  function Jt(a, b) {
    if (!a.c) return a.zc = It(b, a.l), !0;
    if (!b.continuous && 0 < b.Ba.length) return a.zc = It(b, a.l), !0;
    b.continuous = a.c.Ig;
    a:{
      var c = a.c;
      var d = a.K;
      if (b.size > b.$g || b.ae > b.hh) {
        ...
        if (0 != b.Ba.length && (e += 1 == b.Ba.length ? b.size + d + d : b.size + d, f += b.ae, e > b.$g || f > b.hh)) {
          c = !1;
          break a;
        }
        b.size = e;
        ...
        b.Og.push(c.text);
        d = b.Ba.length - 1;
        0 == d ? b.Hb.push(c.te) : (1 == d && (b.Hb[0] = '<a i=0>' + b.Hb[0] + '</a>'), b.Hb.push('<a i=' + d + '>'), b.Hb.push(c.te), b.Hb.push('</a>'));
        c = !0;
      }
    }
  ...
  function Kt(a, b, c) {
    var d = yt(b, c);
    d && ud(Be(d)) && a.B.push({ node: b, Gh: c, text: d });
  }

  Ft.prototype.b = function(a, b) {
    if (this.c && Jt(this, b)) return Im;
    if (!this.a) {
      ...
      if (!this.h.length && (a = this.B.shift())) {
        ...
        }, b.continuous = !1, Jt(this, b), Im;
      }
      a = this.h.shift() || this.o.shift();
      if (!a) return this.c = null, Jt(this, b), Im;
      this.g = [a.Cj];
    ...
    if (-1 == c) {
      Lt(this);
      if (!a || 3 != a.nodeType && !$r[a.tagName]) b.continuous = !1;
      return this.b;
    }
    var d = !xt(a) && (a.nodeType == Gc && Mt(this) || !Lf(a, 'notranslate') && (Lf(a, bc) || Mt(this)));
    this.g.push(d);
    c = 1 == c;
    if (((d = !!a && (3 == a.nodeType && typeof a.nodeValue === Ub || a.tagName == wa && typeof a.value === Ub || a.tagName == va && Lf(a, bc) || a.tagName == oa && (cs[a.type] || Lf(a, bc)))) || c) && this.G && !Nt(a)) return Gt(this, a, Mt(this), !0), this.a.a.g(), Lt(this), this.b;
    if (c && Mt(this)) {
    ...
    if (d) {
      ...
      if (Mt(this)) {
        ...
        if (ud(Be(l)) && (this.c = {
          Ig: !0, node: st(a),
          text: l, te: He(l), size: this.s ? Fe(l).length : l.length,
        }, Jt(this, b))) {
          return Lt(this), Im;
        }
      }
    ...
    if (c) {
      if (Ot(a) || !a.firstChild && a.tagName != na) return b.continuous = b.continuous && !!bs[a.tagName], this.a.a.g(), Lt(this), this.b;
      if (a.tagName == na) {
        try {
      ...
      Mt(this) && a && (3 ==
        a.nodeType || $r[a.tagName]) ? this.C && 'A' == a.tagName && a.href && this.C(a) : b.continuous = !1;
      return this.b;
    }
    this.a.a.g();
    Lt(this);
  ...
  Pt.prototype.b = function() {
    for (var a = 0; a < this.a.length; ++a) ug(this.a[a]);
    this.a = [];
  };
  ...
  function Xt(a, b, c) {
    ...
    for (var d = '', e = 0, f = a.s; f < a.f.length; ++f) {
      ...
      k = a.a >= b;
      Vt[h] ? (a.g = f, a.l = a.a, k = k || e > c) : ' ' == h && (a.c = f, a.h = a.a, k = k || e > c);
      if (k) {
        return 0 <= a.g ? (d = a.f.substring(a.b, a.g + 1), a.a -= a.l, a.b = a.g + 1, a.g >= a.c ? (a.c = -1, a.h = 0) : a.h -= a.l, a.g = -1, a.l = 0) : 0 <= a.c ? (d = a.f.substring(a.b, a.c + 1), a.a -= a.h, a.b = a.c + 1, a.c = -1, a.h = 0) : (d = a.f.substring(a.b, f + 1), a.a = 0, a.b = f + 1, a.g = a.c =
  ...
  function $t(a, b, c) {
    ...
    do b = a.b, a.b < a.h && (a.b *= a.ua, a.b > a.h && (a.b = a.h)); while (b != a.b && c && a.b < c);
    a.g = a.b;
  }
  ...
  function cu(a, b, c, d, e) {
    return new Ft(a.wa.shift(), { Ej: a.P, Hi: b, Ug: !0, Dj: !!c }, function() {
  ...
  function du(a, b, c) {
    if (0 < a.ca && eu(b) >= a.ca) return !0;
    if (bu(a) > a.b) {
      if (0 < eu(b)) return !0;
      $t(a, c, bu(a));
      for (var d = a.a.ea(), e = new Ut(d, a.P), f; f = Xt(e, a.b, a.c);) {
        if (b.g.push(new St([f], !1)), a.f += f.length, a.c -= f.length, 0 >= a.c) {
          b.B = d.substring(e.b);
          break;
        } else {
          $t(a, c);
  ...
  function pu(a, b) {
    ...
    a = [].concat(this.b);
    for (b = 0; b < a.length; ++b) yg(a[b]) && M(a[b], this.a);
  }
  ...
  pu.prototype.restore = function() {
    for (var a = [].concat(this.b), b = 0; b < a.length; ++b) yg(a[b]) && Nf(a[b], this.a);
  };
  ...
  G(qu, R);
  kr(3046, qu.prototype, { Ki: 1, Mi: 2, Li: 3, Ni: 4 });
  v = qu.prototype;
  v.cb = function() {
  ...
  v.translate = function(a, b, c, d, e) {
    if (d || a != this.a || b != this.c) ru(this), this.Mf && (this.l = new ut); else if (this.b) return;
    this.g = c;
    this.Yc = e;
    this.h = this.qa && !0;
  ...
  v.vg = function(a) {
    a.target == window && (this.K = !0, this.L = 0, Em(this.s, .01));
  };
  v.ni = function(a) {
    if (this.b && this.h) {
      for (var b = 0; b < a.length; b++) if (a[b].target && a[b].target.className && (0 <= a[b].target.className.indexOf(bc) || 0 == a[b].target.className.indexOf('goog-'))) return;
  ...
  v.kg = function(a, b) {
    ...
    a ? (this.P = !1, this.f = this.Ya, this.K || Em(this.s, this.f), a = [].concat(this.B), c = this.s, b.l = z, b.wa = a, b.a = null, b.H = 0, b.s = [], b.G = z, b.C = c, a = new Gm(this, this.s),
      Jm(a, this.rg), Lm(a, C(this.Xf, this)), Mm(a, b), this.H = a) : (this.P = !0, this.f = this.Za, this.K || Em(this.s, this.f), a = new Gm(this, this.s), Jm(a, this.kg), Lm(a, C(this.Xf, this)), Mm(a, b), this.H = a);
    return Im;
  };
  v.yi = function(a, b) {
    if (!this.b) return Im;
    this.G = this.b = !1;
    this.W ? au(b, !0) : (au(b), b.W(b.f));
    if (this.Gb) return this.kg;
    for (a = 0; a < b.s.length; ++a) b.s[a].stop();
    for (a = 0; a < b.J.length; ++a) Zr(b.la, b.J[a]);
    return Im;
  };
  ...
  v.ng = function(a, b) {
    ...
    var c = b.f;
    if (null == c.a) {
      if (!c.ra) return vu(this, a, b.f);
      if (!Om(a)) return Hm;
      c.ra = !1;
      c.a = c.B.zc || null;
      var d = c.a ? c.a : c.B = null;
      if (!d) return vu(this, a, b.f);
      this.o.push(d);
      var e = d.ea();
      if (this.l.has(e, !this.h) || null != b.G[e] && b.G[e]) return e = c.a.G, c.f += e, c.c -= e, c.a = null, this.h && fu(b, d, !1), vu(this, a, b.f);
      this.l.a[d.ea()] = null;
    }
    0 < eu(b) && Em(this.s, .5);
  ...
  v.Cd = function(a, b) {
    if (!this.b || 0 == eu(b)) return Im;
    uu(this, b.f);
    return this.h ? (b.trackVisibility(Nm(a)), this.Ai) : 0 == b.translate(a) ? Im : this.qg;
  };
  v.Ai = function(a, b) {
  ...
  v.Of = function(a, b) {
    ...
    if (this.l.has(b.ea(), !1)) {
      ...
      for (f = e.firstChild; f; f = f.nextSibling) {
        if ('I' ==
          ...
          if (1 == b.a.length) {
            ...
            var m = b.a;
            h = h.$;
            for (var n = [], r, w = l.firstChild; w; w = r) r = w.nextSibling, Et(w);
            for (r = l.firstChild; r; r = r.nextSibling) {
              r.attributes && r.attributes.i ? (l = parseInt(r.attributes.i.nodeValue, 10), !isNaN(l) && 0 <= l && l < m.length && (m[l].de && n[l] ? n[l].T += r.firstChild && 3 == r.firstChild.nodeType ? r.firstChild.nodeValue : Mg(r) : n[l] = zt(h, k, l, r))) : 3 == r.nodeType && h.push({
                R: -1,
                T: Ie(r.nodeValue),
              });
            }
      ...
      f = b.b;
      for (k = 0; k < f.length - 1; ++k) m = f[k], h = Ee(m.$[m.$.length - 1].T), h = h.charCodeAt(h.length - 1), 12288 <= h && 12351 >= h || 65280 <= h && 65519 >= h || (m.$[m.$.length - 1].T += ' ');
      ug(e);
      for (e = 0; e < b.a.length; ++e) {
        e < d.length && e < b.l.length && null != d[e] && (f = b.l[e], k = d[e].start, null != k && (m = f.substring(0, f.length - De(f).length), ' ' == m && (m = ''), m && (k.T = m + De(k.T))), k = d[e].end, null != k && (f = f.substring(Ee(f).length), ' ' == f && (f = ''), f && (k.T =
          Ee(k.T) + f)));
      }
  ...
  v.qg = function(a, b) {
    ...
    if (1 < eu(b)) {
      ...
      if (a.c || 0 == c.length || null == a.a || 0 == a.a.length) {
        ...
        a = 0 < e.length ? { ij: new St(d, !0), jj: e } : null;
      }
    ...
    if (1 < b.b.length) {
      ...
      if (a = b.b[0]) {
        d = c.b,
          a.o = c.ea(), void 0 !== d && (a.C = d), a.H = c.f, a.g = c.c;
      }
    }
    if (this.h) {
      a = C(this.Of, this);
  ...
  v.ld = function(a) {
    ...
    if (b) {
      ...
      b = b.join(' ');
      a = e.b.vc(a);
      e.b.na.send({ q: b.substring(0, e.b.Gg), sl: Ha, tl: 'en' }, a);
    } else {
      this.Ze(), a(null, !0);
    }
  };
  v.ce = function(a, b, c, d, e) {
    ...
    lr();
    if (!a || jr(a, b)) a = Ha;
    if (e || a != this.a || b != this.c) this.o = new ut;
    this.a = a;
    this.c = b;
    this.b.Ua() ? (d = d || document.documentElement, this.f && this.f.M(), this.B.reset(), this.f = new qu(d, this.b, this.K, this.L, this.C, !0, this.H, this.o, this.l, this.B), this.f.jb = this.s, this.h = !0, this.f.translate(a, b, c, e, C(this.Qi, this, f, a, b))) : (this.Ze(), c(0, !1, !0));
  };
  v.tj = function() {
  ...
  v.Qi = function(a, b, c, d) {
    this.h && (this.h = !1, b = {
      ...
      tl: c,
      textlen: d,
    }, this.s && (b.ctt = '1'), '' != this.g && (b.sp = this.g), 0 != this.g.indexOf('nmt') && (b.sp = '' != this.g ? 'nmt,' + this.g : 'nmt'), b.ttt = D() - a, b.ttl = this.J, this.G && (b.ttf = this.G), this.l && (b.sr = 1), dr('te_time', b));
  };
  ...
  v.D = function() {
    this.fd();
    this.o = this.j();
    this.f = kg(na, { frameBorder: 0, 'class': 'goog-te-menu-frame skiptranslate', title: Z.Jf });
    this.f.style.visibility = dc;
    Q(this.f, !1);
    document.body.appendChild(this.f);
  };
  v.Wf = function() {
    var a = nd.test(Cq) ? Qb : 'ltr', b = pr(this.a.Va), c = V(this, 'menuBody');
  ...
  v.Bd = function() {
    this.W && (this.W = !1, Bu(this, !1), jg(O(this.o)).focus());
  };
  v.mf = fc();
  v.nf = fc();
  ...
  function Bu(a, b) {
    if ('undefined' == typeof b || b) {
      ...
      if (I && !L('7.0')) {
        ...
        h = hg(document), c -= h.y, d -= h.y, e -= h.x, f -= h.x;
      }
      h = fg(window);
  ...
  v.Tc = function(a) {
    ...
    for (var b in a) {
      if (a[b] !== Object.prototype[b]) {
        if ('---' == a[b]) {
          var c = { link: this.c.D(g, { className: 'goog-te-menu2-separator', value: b }), Fi: !0 };
          this.h.push(c);
        } else {
          ...
          this.a.Xd && this.c.appendChild(d, this.c.D(ua, { className: 'indicator' }, '\u203a'));
  ...
  Fu.prototype.fd = function() {
    ...
    var b = this.b.D(g, { style: 'background: url(' + Mq + ') repeat-x 0 -39px' });
    a.appendChild(b);
    this.H = Pg(this.b, Ma);
  ...
  v.D = function() {
    ...
    Q(a, !1);
    if (2 == this.a.Rb) {
      a.innerHTML = hs({ id: V(this, Wb), Qg: '', Pg: '' });
    } else {
      var b = Z.rh(is() || '');
      a.innerHTML = hs({ id: V(this, Wb), Qg: '', Pg: nr(1 == this.a.Rb ? '&nbsp;&nbsp;' + b : b) });
    }
    this.S(a);
  };
  v.O = function() {
  ...
  v.wj = function() {
    if (2 == this.a.Rb) {
      var a = this.f, b = this.b.j(V(this, Wb));
      a.l.ba(a.o, Sa, a.Me);
      a.o = b;
      a.l.w(a.o, Sa, a.Me);
    }
  ...
  v.O = function() {
    Ku.m.O.call(this);
    var a = nd.test(Cq) ? Qb : 'ltr', b = pr(this.a.Va), c = V(this, bc);
  ...
  function Mu(a, b) {
    ...
    I && (window._bannerquirkfixleft = -parseInt('0' + this.b.a.body.leftMargin, 10), window._bannerquirkfixtop = -parseInt('0' + this.b.a.body.topMargin, 10) - 40);
  }
  ...
  v.O = function() {
    Mu.m.O.call(this);
    var a = nd.test(Cq) ? Qb : 'ltr', b = pr(this.a.Va), c = V(this, 'promptSection'), d = V(this, 'confirm'),
      e = V(this, Lb), f = V(this, 'progressValue'), h = V(this, 'cancel'), k = V(this, 'finishSection'),
      l = V(this, 'restore'), m = V(this, 'errorSection'), n = V(this, 'errorContent'), r = V(this, 'close'),
      w = V(this, 'noAutoPopup'), F, E = [];
    this.a.zf && E.push(gs({ id: V(this, Mb) }));
    E.push(gs({ id: V(this, Nb) }));
    var ca = nr(Z.Bh.apply(null, E));
    E = [];
    this.a.zf && E.push(gs({ id: V(this, ab) }));
    E.push(gs({ id: V(this, bb) }));
    var $l =
      nr(Z.wh.apply(null, E));
    ...
    er(this.l, C(function() {
      ...
      tb = pk(ja + X(Dk(b)) + '"></head><body class="goog-te-banner" scroll="no" border=0 dir="' + X(a) + '"><table border=0 cellspacing=0 cellpadding=0 width=100% height=100%><tr valign=middle><td width=1 nowrap><a href="' + X(wk(ub)) + '" class="goog-logo-link" target="_blank"><img src="' + X(Bk('https://www.gstatic.com/images/branding/googlelogo/1x/googlelogo_color_68x28dp.png')) +
        ...
        X(n) + '" class="goog-te-banner-content"></span></td></tr></table></td><td><td class="goog-te-banner-margin"></td></td><td width=1 id="options"></td><td width=1><a id="' + X(r) + '" class="goog-close-link" href="javascript:void(0)" title="' + X(Z.Hf) + '"><img src="' + X(Bk(vb)) + '" width="15" height="15" alt="' + X(Z.Hf) + aa + X(Bk(Nq)) + ');background-position:-28px 0px"></a></td></tr></table></body>');
      tb = hk(tb);
      hf.write(ke(tb));
      hf.close();
    }, this));
  ...
  v.uj = function() {
    ...
    this.h.w(this.c.j(V(this,
      'restore')), Sa, ar(this, 'clk_restore'));
  ...
  v.vj = function() {
    this.o.Wg(Z.ph);
    this.o.Tc({ turn_off_site: Z.zh, s1: '---', learn_more: Z.oh });
    this.dispatchEvent(zb);
  };
  v.pi = function() {
    switch (this.o.Aa()) {
  ...
  function Ou(a, b, c, d) {
    if (a.yc != b) {
      ...
      if (0 == b) {
        ...
        2 == b && (a.g && yu(a.g, a.c.j(V(a, ab))), a.C && (e = a.oa(), a.f.Db(a.C), a.ta(e)), yu(a.f, a.c.j(V(a, bb))));
      }
      e = {};
  ...
  v.I = function(a) {
    if (this.ga != a) {
      this.ga = a;
      if (I) var b = parseInt('0' + this.b.a.body.leftMargin, 10), c = parseInt('0' + this.b.a.body.topMargin, 10);
      var d = 'BackCompat' == this.b.a.compatMode;
      a ? (P(this.b.a.body, 'top', '40px'), Q(this.j(), !0), I && (L('7.0') ? (window._bannerquirkfixleft = window._bannerquirkfixtop = 0, d && (this.b.a.body.topMargin = c + 40)) : d ? (this.b.a.body.topMargin = c + 40, window._bannerquirkfixleft = window._bannerquirkfixtop = 0) : (window._bannerquirkfixleft = -b, window._bannerquirkfixtop = -c - 40))) : (P(this.b.a.body, 'top',
  ...
  function Pu(a, b) {
    ...
    this.qa = { Va: Qq, ah: 'https://' == Lq ? Z.uh : null };
    this.P = { Va: Qq, kd: null };
    a && ('autoDisplay' in a && (this.a.le = this.a.le && !!a.autoDisplay), 'multilanguagePage' in a && (this.a.kc = !!a.multilanguagePage), 'gaTrack' in a && (this.a.$f = !!a.gaTrack), 'layout' in a && (this.a.Rb = a.layout), a.pageLanguage && (this.a.Vd = br(a.pageLanguage)), a.includedLanguages && (this.a.Se = a.includedLanguages.split(',')),
    a.excludedLanguages && (this.a.Yf = a.excludedLanguages.split(',')), this.a.Vd && (this.g = this.a.Vd), a.key && (this.a.$a = a.key), a.gaId && (this.a.ve = a.gaId), this.P.kd = Number(a.floatPosition) || this.P.kd, 'disableAutoTranslation' in a && (this.a.Uf = !!a.disableAutoTranslation), a.jwtToken && (this.W = new Tr(a.jwtToken)), a.jwtTokenProvider && (this.W = new Ur(a.jwtTokenProvider)), a.translateErrorHandler && (this.Vb = a.translateErrorHandler));
    !this.a.Uf && Qu(this) && (this.a.Zf = !0);
    this.s = {};
    if ((a = document.cookie.match(/(^|; )googtransopt=(.*?)(;|$)/)) &&
      a[2]) {
      for (this.s = {}, a = Ge(a[2]).split('|'), b = 0; b < a.length; ++b) {
        var c = a[b].split('=');
        c[0] && (this.s[c[0]] = c[1]);
      }
    }
    this.ua = new jt({ $a: this.a.$a, Kb: 1, yf: !0, Fk: Sq }, { client: Iq, u: window.location.href });
    ...
    this.ca ? (this.f =
      new Gu(this.a), this.h.w(this.f, zb, this.K.register()), this.h.w(this.f, Ra, Yq(this.L, this.C.delay(C(this.hi, this)))), this.f.fa(this.ca)) : this.P.kd && (this.l = new Ku(this.P), this.h.w(this.l, zb, this.K.register()), this.h.w(this.l, 'clk_trans', Yq(this.L, this.C.delay(C(this.gi, this)))), this.l.fa());
  ...
  function Qu(a) {
    function b(f, h) {
      if (f = Ge(f).match('^\\((([a-zA-Z\\-_]*)\\|)?([a-zA-Z\\-_]*)\\)|^/(([a-zA-Z\\-_]*)/)?([a-zA-Z\\-_]*)')) {
        if (f[3]) return h.a.me = f[2], h.a.bd = f[3], !0;
        if (f[6]) return h.a.me = f[5], h.a.bd = f[6], !0;
      }
      return !1;
    }
  ...
  v.ii = function(a) {
    ...
    this.J = {};
    a = !this.a.Se.length;
    var b = Uq(this.a.Se), c = Uq(this.a.Yf);
    this.o[Cq] = '';
    this.J[Cq] = '';
    for (var d in this.H.tl) this.H.tl[d] === Object.prototype[d] || !(a || d in b) || d in c || (this.J[d] = this.H.tl[d], d == this.a.Vd && !this.a.kc) || (this.o[d] = this.H.tl[d]);
  ...
  v.ji = function() {
    ...
    if (this.H) {
      ...
      !Eq &&
      a ? this.a.bd ? Yq(this.L, this.C.delay(C(this.Wd, this, !0, !0))).call() : (this.G = !0, Yq(this.L, this.C.delay(C(this.Wd, this))).call(), dr('te_ap', { sl: this.g })) : (this.l && this.l.I(!0), this.f && this.f.I(!0));
  ...
  v.Yh = function() {
    !this.b.isVisible() || !this.a.kc && jr(this.g, this.b.oa()) || (this.G && dr("te_apt", { sl: this.g }), Tu(this, !1), this.f && this.f.ta(this.b.oa()))
  };
  v.Xh = function() {
    this.b.isVisible() && (Uu(this), Ou(this.b, 0), this.f && this.f.ta(""))
  };
  v.Ke = function() {
    this.b.isVisible() && (Uu(this), Ou(this.b, 0));
    this.f && this.f.ta("")
  };
  v.Ad = function() {
    this.b.isVisible() && (this.G && (this.G = !1, dr("te_apc", { sl: this.g })), Uu(this), this.b.I(!1), this.f && this.f.ta(""), this.l && this.l.I(!0))
  };
  v.Zh = function() {
    this.b.isVisible() && (this.s["o" + this.g] = "1", dr("te_apr", { sl: this.g }), this.G = !1, this.Ad())
  };
  v.$h = function() {
    if (this.b.isVisible()) {
      this.G = !1;
  ...
  v.jg = function() {
    this.b.isVisible() && (!this.a.kc && jr(this.g, this.b.oa()) ? this.Ke() : (this.g = this.b.cb() || this.g, this.c = this.b.oa(), 2 == this.b.yc && (this.f && this.f.ta(this.b.oa()), Tu(this))))
  };
  v.Wd = function(a, b) {
    this.b.isVisible() || (this.l && this.l.I(!1), a ? Tu(this, b) : Ou(this.b, 0, !0, this.G))
  };
  v.oj = function(a, b) {
  ...
  v.hi = function() {
    this.f.oa() ? !this.a.kc && jr(this.g, this.b.oa()) ? this.Ke() : (this.c = this.f.oa(), this.b.ta(this.c), Tu(this)) : this.f.ta(this.c)
  };
  ...
  v.vi = function(a, b, c) {
    A(this.ra) == p && this.ra();
    this.b.isVisible() && 1 == this.b.yc && (c ? (Uu(this), Ou(this.b, -1, !0), 2 == c ? Nu(this.b, Z.nh) : Nu(this.b, Z.If)) : (this.b.vf(a), b && (this.f && this.f.ta(this.c), this.b.Tb(this.g), Ou(this.b, 2))))
  };
  ...
  if (1 == Hq) {
    ...
    var av = null, bv = function(a, b) {
      av || (av = new Pu(a, b), av.constructor = z);
      return av
    };
